...
import org.jkiss.sqbase.ui.search.AbstractSearchPage;
import org.jkiss.sqbase.ui.search.internal.UISearchMessages;
        ...
        if (assistant == null) {
            ...
            for (DBSObjectType objectType : assistant.getSupportedObjectTypes()) {
                ...
                if (objectType.getImage() != null) {
                    item.setImage(0, SQBaseIcons.getImage(objectType.getImage()));
                }
