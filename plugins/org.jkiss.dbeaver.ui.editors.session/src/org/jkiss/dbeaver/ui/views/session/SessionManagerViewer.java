 ...
 */
package org.jkiss.sqbase.ui.views.session;
...
import org.jkiss.sqbase.model.DBPObjectWithDescription;
import org.jkiss.sqbase.model.DBUtils;
import org.jkiss.sqbase.model.admin.sessions.*;
...
import org.jkiss.sqbase.ui.editors.SubEditorSite;
import org.jkiss.sqbase.ui.editors.sql.SQLEditorBase;
import org.jkiss.sqbase.ui.editors.sql.handlers.SQLEditorHandlerOpenObjectConsole;
...
import org.jkiss.sqbase.ui.navigator.itemlist.DatabaseObjectListControl;
import org.jkiss.sqbase.ui.properties.PropertyTreeViewer;
import org.jkiss.sqbase.ui.views.session.internal.SessionEditorMessages;
    ...
    protected SessionManagerViewer(IWorkbenchPart part, Composite parent, final DBAServerSessionManager<SESSION_TYPE> sessionManager) {
...

        {
...

            {
                ...
                sqlViewItem.setImage(SQBaseIcons.getImage(DBIcon.SQL_TEXT));
...

            {
                ...
                detailsItem.setImage(SQBaseIcons.getImage(UIIcon.PROPERTIES));
                    ...
                    if (sessionDetails != null) {
                        for (DBAServerSessionDetails detailsInfo : sessionDetails) {
                            ...
                            if (detailsInfo.getDetailsIcon() != null) {
                                extDetailsItem.setImage(SQBaseIcons.getImage(detailsInfo.getDetailsIcon()));
                            }
...
//        planTree.substituteProgressPanel(getSessionListControl());
        ...
        sqlPlanItem.setImage(SQBaseIcons.getImage(UIIcon.SQL_PAGE_EXPLAIN_PLAN));
    ...
    void loadSettings(AbstractSessionEditor sessionEditor) {
        //$NON-NLS-1$
        settings = UIUtils.getDialogSettings("SQBase." + sessionEditor.getClass().getSimpleName());
        ...
        public void fillCustomActions(IContributionManager contributionManager) {
                ...
                ((DBAServerSessionManagerSQL) sessionManager).canGenerateSessionReadQuery())
            {
                contributionManager.add(ActionUtils.makeActionContribution(new Action(SessionEditorMessages.viewer_open_sql_editor_text, IAction.AS_PUSH_BUTTON) {
                    {
                        setImageDescriptor(SQBaseIcons.getImageDescriptor(DBIcon.TREE_SCRIPT));
            ...
            contributionManager.add(new Action(SessionEditorMessages.viewer_session_manager_refresh_sessions_action, SQBaseIcons.getImageDescriptor(UIIcon.REFRESH)) {
                @Override
                public void run()
                {
                    refreshSessions();
