 ...
 */
package org.jkiss.sqbase.ui.views.session.internal;

import org.eclipse.osgi.util.NLS;

public class SessionEditorMessages extends NLS {

    static final String BUNDLE_NAME = "org.jkiss.sqbase.ui.views.session.internal.SessionEditorMessages"; //$NON-NLS-1$
