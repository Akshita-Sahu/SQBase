 ...
 */
package org.jkiss.sqbase.ui.gis.panel;
...
import org.jkiss.sqbase.data.gis.handlers.WKGUtils;
...
import org.jkiss.sqbase.model.gis.*;
...
import org.jkiss.sqbase.model.virtual.DBVUtils;
import org.jkiss.sqbase.runtime.DBWorkbench;
import org.jkiss.sqbase.runtime.IVariableResolver;
import org.jkiss.sqbase.ui.*;
import org.jkiss.sqbase.ui.controls.lightgrid.GridPos;
import org.jkiss.sqbase.ui.controls.resultset.AbstractPresentation;
import org.jkiss.sqbase.ui.controls.resultset.IResultSetPresentation;
import org.jkiss.sqbase.ui.controls.resultset.spreadsheet.SpreadsheetPresentation;
import org.jkiss.sqbase.ui.css.CSSUtils;
import org.jkiss.sqbase.ui.dialogs.DialogUtils;
import org.jkiss.sqbase.ui.gis.GeometryDataUtils;
import org.jkiss.sqbase.ui.gis.GeometryViewerConstants;
import org.jkiss.sqbase.ui.gis.IGeometryValueEditor;
import org.jkiss.sqbase.ui.gis.internal.GISMessages;
import org.jkiss.sqbase.ui.gis.internal.GISViewerActivator;
import org.jkiss.sqbase.ui.gis.panel.actions.ToggleLabelsAction;
import org.jkiss.sqbase.ui.gis.registry.GeometryViewerRegistry;
import org.jkiss.sqbase.ui.gis.registry.LeafletTilesDescriptor;
...
public class GISLeafletViewer implements IGeometryValueEditor, DBPPreferenceListener {
    ...
    void populateToolbar() {
        ...
        toolBarManager.add(new Action(GISMessages.panel_leaflet_viewer_tool_bar_action_text_open, SQBaseIcons.getImageDescriptor(UIIcon.BROWSER)) {
            @Override
            public void run() {
                ShellUtils.launchProgram(server.getUrl());
            }
        });
        toolBarManager.add(new Action(GISMessages.panel_leaflet_viewer_tool_bar_action_text_copy_as, SQBaseIcons.getImageDescriptor(UIIcon.PICTURE)) {
            @Override
            public void run() {
        ...
        toolBarManager.add(new Action(GISMessages.panel_leaflet_viewer_tool_bar_action_text_save_as, SQBaseIcons.getImageDescriptor(UIIcon.PICTURE_SAVE)) {
            @Override
            public void run() {
        ...
        toolBarManager.add(new Action(GISMessages.panel_leaflet_viewer_tool_bar_action_text_print, SQBaseIcons.getImageDescriptor(UIIcon.PRINT)) {
            @Override
            public void run() {
        ...
        toolBarManager.add(new Action(GISMessages.panel_leaflet_viewer_tool_bar_action_text_flip, Action.AS_CHECK_BOX) {
            {
                ...
                setImageDescriptor(SQBaseIcons.getImageDescriptor(UIIcon.LINK_TO_EDITOR));
            }
        ...
        toolBarManager.add(new Action(GISMessages.panel_leaflet_viewer_tool_bar_action_text_show_hide, Action.AS_CHECK_BOX) {
            {
                setImageDescriptor(SQBaseIcons.getImageDescriptor(UIIcon.PALETTE));
            }
