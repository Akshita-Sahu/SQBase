...
import org.jkiss.sqbase.ui.gis.IGeometryViewer;
import org.jkiss.sqbase.ui.gis.internal.GISMessages;
import org.jkiss.sqbase.ui.gis.registry.GeometryViewerDescriptor;
...
public class GISPanelEditor extends BaseValueEditor<Control> {
    ...
    private class ViewerSwitchAction extends Action implements SelectionListener {
        ...
        ViewerSwitchAction() {
            ...
            setImageDescriptor(SQBaseIcons.getImageDescriptor(DBIcon.TREE_SCRIPT_FOLDER));
    ...
    private class ViewerSetAction extends Action {
        ...
        ViewerSetAction(GeometryViewerDescriptor vd) {
            ...
            if (viewerDescriptor.getIcon() != null) {
                setImageDescriptor(SQBaseIcons.getImageDescriptor(viewerDescriptor.getIcon()));
            }
