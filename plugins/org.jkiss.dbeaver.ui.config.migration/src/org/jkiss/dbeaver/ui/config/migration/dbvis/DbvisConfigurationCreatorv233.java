...
package org.jkiss.sqbase.ui.config.migration.dbvis;
...
import org.jkiss.sqbase.ui.config.migration.wizards.ImportConnectionInfo;
import org.jkiss.sqbase.ui.config.migration.wizards.ImportData;
import org.jkiss.sqbase.ui.config.migration.wizards.ImportDriverInfo;
...
public class DbvisConfigurationCreatorv233 extends DbvisAbstractConfigurationCreator {
    ...
    public static final Map<String, String> dbvis2sqbaseDriverNames = new HashMap<>();
    static {
        dbvis2sqbaseDriverNames.put("H2 2.x Embedded", "H2 Embedded V.2"); //$NON-NLS-1$ $NON-NLS-2$
        dbvis2sqbaseDriverNames.put("Oracle 9i", "Oracle"); //$NON-NLS-1$ $NON-NLS-2$
        dbvis2sqbaseDriverNames.put("Db2 LUW", "Db2 for LUW"); //$NON-NLS-1$ $NON-NLS-2$
    }
    ...
    protected String substituteDriverName(String driverName) {
        String driversubstitutedName = dbvis2sqbaseDriverNames.get(driverName);
