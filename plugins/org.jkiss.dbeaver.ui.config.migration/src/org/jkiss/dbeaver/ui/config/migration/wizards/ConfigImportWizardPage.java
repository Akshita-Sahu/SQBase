 ...
 */
package org.jkiss.sqbase.ui.config.migration.wizards;
...
import org.jkiss.sqbase.ui.config.migration.ImportConfigMessages;
import org.jkiss.sqbase.ui.controls.ConnectionFolderSelector;
import org.jkiss.sqbase.ui.dialogs.ActiveWizardPage;
import org.jkiss.sqbase.ui.navigator.NavigatorUtils;
import org.jkiss.sqbase.ui.navigator.dialogs.ObjectListDialog;
...
public abstract class ConfigImportWizardPage extends ActiveWizardPage<ConfigImportWizard> {
    ...
    private void setConnectionInfoForItem(ImportConnectionInfo connectionInfo,
        ...
        if (connectionInfo.getDriverInfo() != null) {
            item.setImage(0, SQBaseIcons.getImage(DBIcon.TREE_DATABASE));
            ...
            item.setImage(0, SQBaseIcons.getImage(DBIcon.DATABASE_DEFAULT));
            item.setText(0, connectionInfo.getAlias());
