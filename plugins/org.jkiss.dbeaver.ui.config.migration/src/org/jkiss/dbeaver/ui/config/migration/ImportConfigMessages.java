 ...
 */
package org.jkiss.sqbase.ui.config.migration;

import org.eclipse.osgi.util.NLS;

public class ImportConfigMessages extends NLS {
    private static final String BUNDLE_NAME = "org.jkiss.sqbase.ui.config.migration.ImportConfigMessages"; //$NON-NLS-1$
