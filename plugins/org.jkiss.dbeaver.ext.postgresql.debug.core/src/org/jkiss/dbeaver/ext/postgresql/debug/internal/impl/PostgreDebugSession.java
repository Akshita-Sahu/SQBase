...
package org.jkiss.sqbase.ext.postgresql.debug.internal.impl;
...
import org.jkiss.sqbase.debug.*;
import org.jkiss.sqbase.debug.core.DebugUtils;
import org.jkiss.sqbase.debug.jdbc.DBGJDBCSession;
import org.jkiss.sqbase.ext.postgresql.PostgreConstants;
import org.jkiss.sqbase.ext.postgresql.debug.PostgreDebugConstants;
import org.jkiss.sqbase.ext.postgresql.debug.core.PostgreSqlDebugCore;
import org.jkiss.sqbase.ext.postgresql.debug.internal.PostgreDebugCoreMessages;
import org.jkiss.sqbase.ext.postgresql.model.PostgreDataSource;
    ...
    public void attach(DBRProgressMonitor monitor, Map<String, Object> configuration) throws DBException {
        if (!checkDebugPlugin(monitor)) {
            throw new DBGException("PostgreSQL debug plugin is not installed on the server.\n" +
                ...
                "https://github.com/sqbase/sqbase/wiki/PGDebugger#installation");
        }
