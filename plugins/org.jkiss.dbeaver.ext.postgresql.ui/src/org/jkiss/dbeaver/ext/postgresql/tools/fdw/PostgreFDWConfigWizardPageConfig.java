...
import org.jkiss.sqbase.ext.postgresql.model.PostgreForeignDataWrapper;
...
import org.jkiss.sqbase.ext.postgresql.model.fdw.FDWConfigRegistry;
...
class PostgreFDWConfigWizardPageConfig extends ActiveWizardPage<PostgreFDWConfigWizard> {
    ...
    private void loadSettings() {
        ...
        for (DBNDatabaseNode entityNode : getWizard().getSelectedEntities()) {
            ...
            item.setImage(0, SQBaseIcons.getImage(entityNode.getNodeIconDefault()));
