...
import org.jkiss.sqbase.ext.postgresql.PostgreUIUtils;
...
import org.jkiss.sqbase.ext.postgresql.tasks.PostgreDatabaseBackupInfo;
import org.jkiss.sqbase.model.DBIcon;
import org.jkiss.sqbase.model.DBUtils;
import org.jkiss.sqbase.model.impl.jdbc.struct.JDBCTable;
...
import org.jkiss.sqbase.tasks.ui.nativetool.AbstractNativeToolWizardPage;
...
class PostgreBackupWizardPageObjects extends AbstractNativeToolWizardPage<PostgreBackupWizard>
{
    ...
    public void createControl(Composite parent)
    {
        ...
        connInfo.setImage(SQBaseIcons.getImage(DBIcon.DATABASE_DEFAULT));
        ...
        if (dataBase != null) {
            ...
            try {
                for (PostgreSchema schema : dataBase.getSchemas(new VoidProgressMonitor())) {
                    ...
                    item.setImage(SQBaseIcons.getImage(DBIcon.TREE_SCHEMA));
