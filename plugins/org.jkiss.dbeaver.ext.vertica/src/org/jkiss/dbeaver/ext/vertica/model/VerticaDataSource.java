 ...
 */
package org.jkiss.sqbase.ext.vertica.model;
...
import org.jkiss.sqbase.ext.vertica.VerticaConstants;
import org.jkiss.sqbase.ext.vertica.internal.VerticaMessages;
...
public class VerticaDataSource extends GenericDataSource {
    ...
    private boolean checkForPasswordWillExpireWarning(@NotNull SQLWarning warning) {
        ...
        // [Vertica][VJDBC](100069) The password for user sqbase_test3 will expire soon.  Please consider changing it.
