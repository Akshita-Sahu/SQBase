...
package org.jkiss.sqbase.tasks.ui;
...
import org.jkiss.sqbase.model.connection.DBPEditorContribution;
import org.jkiss.sqbase.model.exec.DBCExecutionContext;
import org.jkiss.sqbase.model.navigator.meta.DBXTreeNode;
import org.jkiss.sqbase.model.navigator.meta.DBXTreeObject;
import org.jkiss.sqbase.model.struct.DBSObject;
import org.jkiss.sqbase.runtime.DBWorkbench;
import org.jkiss.sqbase.tasks.ui.view.DatabaseTasksView;
import org.jkiss.sqbase.tools.registry.ToolDescriptor;
import org.jkiss.sqbase.tools.registry.ToolGroupDescriptor;
import org.jkiss.sqbase.tools.registry.ToolsRegistry;
import org.jkiss.sqbase.ui.ActionUtils;
import org.jkiss.sqbase.ui.SQBaseIcons;
import org.jkiss.sqbase.ui.UIUtils;
import org.jkiss.sqbase.ui.actions.EmptyListAction;
import org.jkiss.sqbase.ui.actions.datasource.DataSourceMenuContributor;
...
public class DataSourceToolsContributor extends DataSourceMenuContributor
{
                ...
                if (activePart != null) {
                    ...
                    for (ToolDescriptor tool : tools) {
                        ...
                        IAction action = ActionUtils.makeAction(
                            ...
                            "execute-tool",
                            tool.getLabel(),
                            tool.getIcon() == null ? null : SQBaseIcons.getImageDescriptor(tool.getIcon()),
                            tool.getDescription());
                        if (parentMenu == null) {
    ...
    private class OpenToolsEditorAction extends Action {
        ...
        public OpenToolsEditorAction(IWorkbenchPage workbenchPage, DBPDataSource dataSource, DBPEditorContribution editor) {
            super(editor.getLabel(), SQBaseIcons.getImageDescriptor(editor.getIcon()));
    ...
    public static class DataSourceEditorInput implements IEditorInput, DBPDataSourceContainerProvider, DBPContextProvider {
        ...
        public ImageDescriptor getImageDescriptor() {
            return SQBaseIcons.getImageDescriptor(editor.getIcon());
        }
