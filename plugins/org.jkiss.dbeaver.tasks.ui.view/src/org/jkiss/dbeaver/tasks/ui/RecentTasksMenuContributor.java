...
import org.jkiss.sqbase.tasks.ui.view.TaskHandlerRun;
...
public class RecentTasksMenuContributor extends DataSourceMenuContributor
{
    ...
    protected void fillContributionItems(final List<IContributionItem> menuItems)
    {
        ...
        for (DBTTask task : tasks) {
            ...
            menuItems.add(ActionUtils.makeActionContribution(new Action(task.getName(), SQBaseIcons.getImageDescriptor(taskIcon)) {
                @Override
                public void run() {
