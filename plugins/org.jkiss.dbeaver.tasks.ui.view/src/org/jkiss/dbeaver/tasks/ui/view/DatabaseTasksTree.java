...
import org.jkiss.sqbase.registry.task.TaskImpl;
...
public class DatabaseTasksTree {
    ...
    public void loadViewConfig() {
        ...
        groupByCategory = preferenceStore.getBoolean("sqbase.tasks.view.groupByCategory");
        groupByType = preferenceStore.getBoolean("sqbase.tasks.view.groupByType");

    }

    public void saveViewConfig() {
        DBPPreferenceStore preferenceStore = DBWorkbench.getPlatform().getPreferenceStore();
        preferenceStore.setValue("sqbase.tasks.view.groupByCategory", groupByCategory);
        preferenceStore.setValue("sqbase.tasks.view.groupByType", groupByType);
        try {
    ...
    private abstract class TaskLabelProvider extends ColumnLabelProvider {
        ...
        public final void update(ViewerCell cell) {
            ...
            if (cellImage != null) {
                cell.setImage(SQBaseIcons.getImage(cellImage));
            }
