...
import org.jkiss.sqbase.ext.altibase.AltibaseUtils;
...
public class AltibaseMetaModel extends GenericMetaModel {
    ...
    public JDBCStatement prepareTableTriggersLoadStatement(@NotNull JDBCSession session, 
        ...
        JDBCPreparedStatement dbStat = session.prepareStatement(
                "SELECT"
                        + "   TR.OWNER_SCHEMA"
                        + " , TR.OWNER_TABLE AS OWNER" // SQBase dependent column alias
    ...
    private String getDDLFromDbmsMetadata(DBRProgressMonitor monitor, DBSObject sourceObject, String schemaName, String objectType) {
         ...
         * Need to use native CallableStatement
            ...
            at org.jkiss.sqbase.model.impl.jdbc.exec.JDBCCallableStatementImpl.getOutputParametersFromJDBC
            (JDBCCallableStatementImpl.java:316)
            at org.jkiss.sqbase.model.impl.jdbc.exec.JDBCCallableStatementImpl.<init>(JDBCCallableStatementImpl.java:115)
            at org.jkiss.sqbase.model.impl.jdbc.exec.JDBCFactoryDefault.createCallableStatement(JDBCFactoryDefault.java:48)
         */
