...
package org.jkiss.sqbase.ext.cubrid.ui.editors;
...
import org.jkiss.sqbase.ext.cubrid.ui.config.CubridPrivilageHandler;
                            ...
                            () -> {
                                ...
                                for (CubridPrivilage privilage : cubridUsers) {
                                    if (privilage.isPersisted() && !privilage.getName().equals(user.getName())) {
                                        ...
                                        item.setImage(SQBaseIcons.getImage(DBIcon.TREE_USER_GROUP));
