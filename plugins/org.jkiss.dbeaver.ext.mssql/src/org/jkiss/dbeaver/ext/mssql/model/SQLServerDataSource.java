...
import org.jkiss.sqbase.ext.mssql.SQLServerMessages;
...
import org.jkiss.sqbase.model.impl.sql.QueryTransformerTop;
...
//            String keyStorePath = certificateStorage.getKeyStorePath(getContainer(), "ssl").getAbsolutePath();
     ...
     * and then enter the new password here so SQBase can update stored credentials.
     */
