...
import org.jkiss.sqbase.runtime.ui.UIServiceSecurity;
import org.jkiss.sqbase.ui.*;
import org.jkiss.sqbase.ui.controls.VariablesHintLabel;
import org.jkiss.sqbase.ui.dialogs.AcceptLicenseDialog;
...
public abstract class ConnectionPageAbstract extends DialogPage implements IDataSourceConnectionEditor {
    ...
    protected void createPasswordControls(Composite parent, int hSpan) {
        ...
        if (supportsPasswordView) {
            ...
            showPasswordLabel.setImage(SQBaseIcons.getImage(UIIcon.SHOW_ALL_DETAILS));
