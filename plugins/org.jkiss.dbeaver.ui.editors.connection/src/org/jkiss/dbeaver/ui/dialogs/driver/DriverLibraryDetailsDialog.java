...
import org.jkiss.sqbase.registry.driver.DriverDependencies;
...
public class DriverLibraryDetailsDialog extends HelpEnabledDialog {
    private static final String DIALOG_ID = "SQBase.DriverLibraryDetailsDialog";//$NON-NLS-1$
    ...
    protected Composite createDialogArea(Composite parent) {
        ...
        getShell().setImage(SQBaseIcons.getImage(library.getIcon()));
