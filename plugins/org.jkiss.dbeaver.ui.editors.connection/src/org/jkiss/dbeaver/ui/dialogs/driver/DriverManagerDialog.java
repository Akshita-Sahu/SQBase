...
import org.jkiss.sqbase.registry.driver.DriverUtils;
...
import org.jkiss.sqbase.ui.preferences.PrefPageDrivers;
...
public class DriverManagerDialog extends HelpEnabledDialog implements ISelectionChangedListener, IDoubleClickListener {
    ...
    private static final String DIALOG_ID = "SQBase.DriverManagerDialog";//$NON-NLS-1$
    ...
    protected Composite createDialogArea(@NotNull Composite parent) {
        ...
        ImageDescriptor dialogImage = SQBaseIcons.getImageDescriptor(UIIcon.DRIVER_MANAGER);
    ...
    public void selectionChanged(SelectionChangedEvent event) {
        ...
        //super.updateStatus(new Status(Status.INFO, SQBaseConstants.PLUGIN_ID, selectedDriver == null ? "" : selectedDriver.getDescription()));
        this.updateButtons();
    }
                ...
                for (DBPDataSourceProviderDescriptor dspd : DataSourceProviderRegistry.getInstance().getEnabledDataSourceProviders()) {
                    for (DBPDriver dd : dspd.getDrivers()) {
                        if (dd.isDisabled()) {
                            ...
                            item.setImage(SQBaseIcons.getImage(dd.getIcon()));
