...
import org.jkiss.sqbase.model.connection.DBPNativeClientLocationManager;
import org.jkiss.sqbase.model.connection.LocalNativeClientLocation;
import org.jkiss.sqbase.registry.driver.DriverDescriptor;
import org.jkiss.sqbase.registry.driver.RemoteNativeClientLocation;
...
public class ClientHomesPanel extends Composite {
    ...
    private TableItem createHomeItem(@NotNull DBPNativeClientLocationManager clientManager, @NotNull DBPNativeClientLocation clientLocation, boolean provided) {
        ...
        homeItem.setImage(SQBaseIcons.getImage(UIIcon.HOME));
