...
import org.jkiss.sqbase.registry.DriverCategoryDescriptor;
import org.jkiss.sqbase.registry.DriverManagerRegistry;
...
import org.jkiss.sqbase.ui.controls.finder.viewer.AdvancedListViewer;
import org.jkiss.sqbase.ui.controls.folders.ITabbedFolder;
import org.jkiss.sqbase.ui.controls.folders.TabbedFolderComposite;
import org.jkiss.sqbase.ui.controls.folders.TabbedFolderInfo;
...
public class DriverTabbedViewer extends StructuredViewer {
    ...
    private static final String DIALOG_ID = "SQBase.DriverTabbedViewer";//$NON-NLS-1$
    ...
    private class DriverListFolder implements ITabbedFolder {
        ...
        private class DriverLabelProvider extends LabelProvider implements IToolTipProvider {
            ...
            public Image getImage(Object element) {
                return SQBaseIcons.getImage(((DBPDriver) element).getIconBig());
            }
