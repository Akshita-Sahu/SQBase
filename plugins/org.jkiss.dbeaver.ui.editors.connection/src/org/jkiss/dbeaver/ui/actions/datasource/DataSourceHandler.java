...
import org.jkiss.sqbase.runtime.jobs.ConnectJob;
import org.jkiss.sqbase.runtime.jobs.DisconnectJob;
import org.jkiss.sqbase.ui.*;
import org.jkiss.sqbase.ui.actions.DataSourceHandlerUtils;
import org.jkiss.sqbase.ui.dialogs.ConfirmationDialog;
import org.jkiss.sqbase.ui.editors.entity.handlers.SaveChangesHandler;
...
/*
    public static int checkActiveTransaction(DBCExecutionContext context)
    {
        ...
        if (isContextTransactionAffected(context)) {
            ...
            SQBaseUI.syncExec(closeConfirmer);
            switch (closeConfirmer.result) {
    ...
    static class TransactionEndConfirmDialog extends MessageDialog {
        ...
        public TransactionEndConfirmDialog(DBPDataSource dataSource) {
            super(UIUtils.getActiveShell(),
                "End transaction",
                SQBaseIcons.getImage(UIIcon.TXN_ROLLBACK),
