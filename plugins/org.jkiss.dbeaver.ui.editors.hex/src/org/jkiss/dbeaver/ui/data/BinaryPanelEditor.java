 ...
 */
package org.jkiss.sqbase.ui.data;
...
import org.jkiss.sqbase.ui.editors.binary.BinaryContent;
import org.jkiss.sqbase.ui.editors.binary.HexEditControl;
import org.jkiss.sqbase.ui.editors.binary.pref.HexPreferencesPage;
...
public class BinaryPanelEditor implements IStreamValueEditor<HexEditControl> {
    ...
    public void contributeActions(@NotNull IContributionManager manager, @NotNull final HexEditControl control) throws DBCException {
        manager.add(new Action("Switch Insert/Overwrite mode", SQBaseIcons.getImageDescriptor(UIIcon.CURSOR)) {
            @Override
            public void run() {
