...
import org.jkiss.sqbase.model.app.DBPPolicyProvider;
...
public class ApplicationPolicyProvider implements DBPPolicyProvider {
    ...
    private static final String DBEAVER_REGISTRY_POLICY_NODE = "Software\\SQBase Corp\\SQBase\\policy"; //$NON-NLS-1$
