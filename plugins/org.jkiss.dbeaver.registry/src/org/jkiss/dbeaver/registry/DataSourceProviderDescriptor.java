...
import org.jkiss.sqbase.model.impl.ProviderPropertyDescriptor;
import org.jkiss.sqbase.model.impl.sql.BasicSQLDialect;
import org.jkiss.sqbase.model.navigator.meta.*;
...
import org.jkiss.sqbase.registry.driver.MissingDataSourceProvider;
...
public class DataSourceProviderDescriptor extends AbstractDescriptor implements DBPDataSourceProviderDescriptor {
    ...
    public static final String EXTENSION_ID = "org.jkiss.sqbase.dataSourceProvider"; //$NON-NLS-1$
    ...
    DataSourceProviderDescriptor(DataSourceProviderRegistry registry, String id) {
        super("org.jkiss.sqbase.registry");
        this.registry = registry;
        this.id = id;
        this.name = id;
