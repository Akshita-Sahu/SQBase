 ...
 */
package org.jkiss.sqbase.ui.config.sample;
...
import org.jkiss.sqbase.ui.IWorkbenchWindowInitializer;
...
public class WorkbenchInitializerCreateSampleDatabase implements IWorkbenchWindowInitializer {
    ...
    private static final String SAMPLE_DB1_ID = "sqbase-sample-database-sqlite-1";
    ...
    static void createSampleDatabase(DBPDataSourceRegistry dsRegistry) {
        ...
        dataSource.setName("SQBase Sample Database (SQLite)");
        try {
