 ...
 */
package org.jkiss.sqbase.model.sql.semantics.model;
...
public interface SQLQueryNodeModelVisitor<T, R> {
    ...
    /**
     * Visit SQBase control command (like @echo, @set, @export and so on)
     */
    @Nullable
    R visitCommand(@NotNull SQLCommandModel command, T arg);

    /**
     * Visit SQBase variable used in the SQBase control command
     */
    @Nullable
