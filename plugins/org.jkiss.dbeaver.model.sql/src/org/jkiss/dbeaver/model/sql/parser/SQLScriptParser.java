...
package org.jkiss.sqbase.model.sql.parser;
...
import org.jkiss.sqbase.model.impl.sql.AbstractSQLDialect;
import org.jkiss.sqbase.model.lsm.LSMAnalyzerParameters;
import org.jkiss.sqbase.model.lsm.sql.dialect.SQLStandardAnalyzer;
...
import org.jkiss.sqbase.model.sql.parser.tokens.SQLControlToken;
import org.jkiss.sqbase.model.sql.parser.tokens.SQLTokenType;
import org.jkiss.sqbase.model.sql.parser.tokens.predicates.SQLTokenEntry;
import org.jkiss.sqbase.model.sql.parser.tokens.predicates.SQLTokenPredicateEvaluator;
...
import org.jkiss.sqbase.model.stm.LSMInspections;
import org.jkiss.sqbase.model.stm.STMSource;
import org.jkiss.sqbase.model.text.TextUtils;
import org.jkiss.sqbase.model.text.parser.TPRuleBasedScanner;
import org.jkiss.sqbase.model.text.parser.TPToken;
import org.jkiss.sqbase.model.text.parser.TPTokenAbstract;
import org.jkiss.sqbase.model.text.parser.TPTokenDefault;
...
public class SQLScriptParser {
    ...
    private static final String CLI_ARG_DEBUG_DISABLE_SKIP_TOKEN_EVALUATION = "sqbase.debug.sql.disable-skip-token-evaluation";
        ...
        for (; ; ) {
            ...
            try {
                ...
                if (tokenType == SQLTokenType.T_BLOCK_HEADER) {
                    ...
                    isDelimiter = true;
                    // see https://github.com/sqbase/pro/issues/3935
