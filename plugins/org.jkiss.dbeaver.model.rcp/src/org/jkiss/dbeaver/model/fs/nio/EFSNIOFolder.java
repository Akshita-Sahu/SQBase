...
public final class EFSNIOFolder extends EFSNIOContainer implements IFolder {
    ...
    private final String FOLDER_EMULATION_FILE_NAME = ".sqbase-placeholder";
    private final byte[] FOLDER_EMULATION_FILE_CONTENT =
        "This file is created by SQBase to guarantee support of folders instantiation and deletion."
