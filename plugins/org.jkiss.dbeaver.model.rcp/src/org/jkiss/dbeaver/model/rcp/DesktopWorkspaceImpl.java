...
import org.jkiss.sqbase.registry.ResourceHandlerDescriptor;
import org.jkiss.sqbase.registry.ResourceTypeDescriptor;
import org.jkiss.sqbase.registry.ResourceTypeRegistry;
...
public class DesktopWorkspaceImpl extends EclipseWorkspaceImpl implements DBPWorkspaceDesktop, DBPExternalFileManager {
    ...
    private static final String EXT_FILES_PROPS_STORE = "sqbase-external-files.data";
...
//        }
    ...
    public DBPProject createProject(@NotNull String name, @Nullable String description) throws DBException {
        ...
        try {
            ...
            pDescription.setNatureIds(new String[]{SQBaseNature.NATURE_ID});
