...
import org.jkiss.sqbase.ui.dialogs.ConnectionLostDialog;
...
/**
 * Lazy input. Use by entity editors which are created during SQBase startup (from memo by factory).
 */
public class DatabaseLazyEditorInput implements IDatabaseEditorInput, ILazyEditorInput, IPersistableElement, DBPDataSourceContainerProvider
{
    ...
    {
        return SQBaseIcons.getImageDescriptor(DBIcon.TYPE_OBJECT);
    }
