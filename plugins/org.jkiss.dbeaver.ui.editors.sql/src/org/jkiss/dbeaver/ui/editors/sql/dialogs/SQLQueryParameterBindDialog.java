 ...
 */
package org.jkiss.sqbase.ui.editors.sql.dialogs;
...
import org.jkiss.sqbase.model.sql.SQLQueryParameter;
...
public class SQLQueryParameterBindDialog extends TrayDialog {
    ...
    private static final String DIALOG_ID = "SQBase.SQLQueryParameterBindDialog";//$NON-NLS-1$
...

        {
            ...
            final CustomTableEditor tableEditor = new CustomTableEditor(paramTable) {
                ...
                protected Control createEditor(Table table, int index, TableItem item) {
                    ...
                    Button button = UIUtils.createPushButton(composite, null, SQBaseIcons.getImage(UIIcon.DOTS_BUTTON));
    ...
    private void fillParameterList(boolean hideVariables) {
        ...
        for (SQLQueryParameter param : parameters) {
            ...
            item.setData(param);
            item.setImage(SQBaseIcons.getImage(DBIcon.TREE_ATTRIBUTE));
