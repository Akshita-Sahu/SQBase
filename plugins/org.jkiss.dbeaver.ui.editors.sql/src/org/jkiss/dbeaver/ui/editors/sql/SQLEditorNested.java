...
import org.jkiss.sqbase.model.exec.compile.DBCCompileLog;
import org.jkiss.sqbase.model.exec.compile.DBCSourceHost;
...
import org.jkiss.sqbase.ui.controls.ObjectCompilerLogViewer;
...
import org.jkiss.sqbase.ui.editors.IDatabasePostSaveProcessor;
...
public abstract class SQLEditorNested<T extends DBSObject>
    ...
    public class ViewLogAction extends Action {
        ViewLogAction() {
            super("View compile log", SQBaseIcons.getImageDescriptor(UIIcon.COMPILE_LOG)); //$NON-NLS-2$
        }
