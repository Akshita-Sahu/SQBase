...
import org.jkiss.sqbase.model.sql.parser.*;
import org.jkiss.sqbase.model.sql.semantics.SQLDocumentSyntaxContext;
import org.jkiss.sqbase.model.sql.semantics.completion.SQLQueryCompletionContext;
import org.jkiss.sqbase.runtime.DBWorkbench;
import org.jkiss.sqbase.ui.*;
import org.jkiss.sqbase.ui.controls.resultset.ThemeConstants;
import org.jkiss.sqbase.ui.editors.AbstractStorageEditorInput;
import org.jkiss.sqbase.ui.editors.BaseTextEditorCommands;
import org.jkiss.sqbase.ui.editors.EditorUtils;
import org.jkiss.sqbase.ui.editors.StringEditorInput;
import org.jkiss.sqbase.ui.editors.sql.internal.SQLEditorMessages;
import org.jkiss.sqbase.ui.editors.sql.preferences.*;
import org.jkiss.sqbase.ui.editors.sql.semantics.SQLBackgroundParsingJob;
import org.jkiss.sqbase.ui.editors.sql.semantics.SQLEditorOutlinePage;
import org.jkiss.sqbase.ui.editors.sql.semantics.SQLEditorSemanticMarkersManager;
import org.jkiss.sqbase.ui.editors.sql.semantics.SQLSemanticErrorAnnotation;
import org.jkiss.sqbase.ui.editors.sql.syntax.SQLCharacterPairMatcher;
import org.jkiss.sqbase.ui.editors.sql.syntax.SQLEditorCompletionContext;
import org.jkiss.sqbase.ui.editors.sql.syntax.SQLProblemAnnotation;
import org.jkiss.sqbase.ui.editors.sql.syntax.SQLRuleScanner;
import org.jkiss.sqbase.ui.editors.sql.templates.SQLTemplatesPage;
import org.jkiss.sqbase.ui.editors.sql.util.SQLSymbolInserter;
import org.jkiss.sqbase.ui.editors.text.BaseTextEditor;
        ...
        themeListener = new IPropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent event) {
                if (event.getProperty().equals(IThemeManager.CHANGE_CURRENT_THEME) ||
                    event.getProperty().startsWith("org.jkiss.sqbase.sql.editor")) {
...
*/
    ...
    public void editorContextMenuAboutToShow(IMenuManager menu) {
        ...
        if (!isReadOnly() && textViewer != null && textViewer.isEditable()) {
            ...
            formatMenu.add(ActionUtils.makeCommandContribution(getSite(), "org.jkiss.sqbase.ui.editors.sql.morph.delimited.list"));
            ...
            formatMenu.add(ActionUtils.makeCommandContribution(getSite(), "org.jkiss.sqbase.ui.editors.sql.trim.spaces"));
            formatMenu.add(new Separator());
            formatMenu.add(ActionUtils.makeCommandContribution(getSite(), "org.jkiss.sqbase.ui.editors.sql.word.wrap"));
            formatMenu.add(ActionUtils.makeCommandContribution(getSite(), "org.jkiss.sqbase.ui.editors.sql.comment.single"));
            formatMenu.add(ActionUtils.makeCommandContribution(getSite(), "org.jkiss.sqbase.ui.editors.sql.comment.multi"));
...
//            }
    ...
    protected class ShowPreferencesAction extends Action {
        ShowPreferencesAction() {
            super(SQLEditorMessages.editor_sql_preference, SQBaseIcons.getImageDescriptor(UIIcon.CONFIGURATION));
        }  //$NON-NLS-1$
