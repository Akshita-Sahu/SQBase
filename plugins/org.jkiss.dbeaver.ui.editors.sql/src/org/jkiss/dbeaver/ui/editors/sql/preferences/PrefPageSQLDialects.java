...
import org.jkiss.sqbase.model.sql.registry.SQLDialectDescriptor;
...
public class PrefPageSQLDialects extends AbstractPrefPage implements IWorkbenchPreferencePage, IWorkbenchPropertyPage {
    public static final String PAGE_ID = "org.jkiss.sqbase.preferences.main.sql.dialects"; //$NON-NLS-1$
    ...
    private void createDialectItem(Tree dialectTable, TreeItem parentItem, SQLDialectMetadata dialect) {
        ...
        if (!dialect.isHidden()) {
            ...
            di.setImage(SQBaseIcons.getImage(dialect.getIcon()));
            di.setData(dialect);
        } else {
            di = parentItem;
        }
