...
package org.jkiss.sqbase.ui.editors.sql.variables;
...
import org.jkiss.sqbase.model.exec.DBCScriptContext;
import org.jkiss.sqbase.model.exec.DBCScriptContextListener;
import org.jkiss.sqbase.model.sql.SQLScriptContext;
import org.jkiss.sqbase.model.sql.registry.SQLQueryParameterRegistry;
...
public class SQLVariablesPanel extends Composite implements DBCScriptContextListener {
    ...
    private class VariableListControl extends ProgressPageControl {
        ...
        protected void addSearchAction(IContributionManager contributionManager) {
            contributionManager.add(new Action("Find variable", SQBaseIcons.getImageDescriptor(UIIcon.SEARCH)) {
                @Override
                public void run() {
        ...
        public void fillCustomActions(IContributionManager contributionManager) {
            ...
            addAction = new Action("Add variable", SQBaseIcons.getImageDescriptor(UIIcon.ADD)) {
                @Override
                public void run() {
            ...
            deleteAction = new Action("Delete variable", SQBaseIcons.getImageDescriptor(UIIcon.DELETE)) {
                @Override
                public void run() {
            ...
            showParamsAction.setImageDescriptor(SQBaseIcons.getImageDescriptor(UIIcon.SQL_PARAMETER));
