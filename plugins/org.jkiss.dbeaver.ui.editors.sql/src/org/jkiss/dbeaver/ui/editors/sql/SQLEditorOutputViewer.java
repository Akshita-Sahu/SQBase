...
import org.jkiss.sqbase.model.exec.output.DBCServerOutputReaderExt;
import org.jkiss.sqbase.ui.SQBaseIcons;
import org.jkiss.sqbase.ui.MenuCreator;
...
public class SQLEditorOutputViewer extends Composite implements DBCOutputWriter {
    ...
    private class ConfigureSeverityAction extends Action {
        public ConfigureSeverityAction() {
            ...
            setImageDescriptor(SQBaseIcons.getImageDescriptor(UIIcon.FILTER));
