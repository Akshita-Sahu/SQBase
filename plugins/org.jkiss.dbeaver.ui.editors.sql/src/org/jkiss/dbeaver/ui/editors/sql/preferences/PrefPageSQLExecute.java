...
import org.jkiss.sqbase.ModelPreferences.SQLScriptStatementDelimiterMode;
...
public class PrefPageSQLExecute extends TargetPrefPage {
    ...
    public static final String PAGE_ID = "org.jkiss.sqbase.preferences.main.sqlexecute"; //$NON-NLS-1$
