...
import org.jkiss.sqbase.model.exec.plan.DBCQueryPlannerSerializable;
...
public abstract class SQLPlanSaveProvider implements SQLPlanViewProvider {
    ...
    private static final String[] NAMES = {"SQBase Plan File", "All files"}; //$NON-NLS-1$ //$NON-NLS-2$;
    ...
    public SQLPlanSaveProvider() {
       saveAction = new SaveAction("Save plan", SQBaseIcons.getImageDescriptor(UIIcon.SAVE_AS), this);
    }
