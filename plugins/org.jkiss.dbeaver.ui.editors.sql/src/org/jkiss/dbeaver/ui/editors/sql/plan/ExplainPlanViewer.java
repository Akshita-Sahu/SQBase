 ...
 */
package org.jkiss.sqbase.ui.editors.sql.plan;
...
import org.jkiss.sqbase.model.exec.plan.*;
...
import org.jkiss.sqbase.model.runtime.load.ILoadVisualizerExt;
...
import org.jkiss.sqbase.ui.controls.VerticalButton;
import org.jkiss.sqbase.ui.controls.VerticalFolder;
import org.jkiss.sqbase.ui.editors.sql.SQLEditor;
import org.jkiss.sqbase.ui.editors.sql.SQLPlanSaveProvider;
import org.jkiss.sqbase.ui.editors.sql.SQLPlanViewProvider;
...
import org.jkiss.sqbase.ui.editors.sql.plan.registry.SQLPlanViewDescriptor;
import org.jkiss.sqbase.ui.editors.sql.plan.registry.SQLPlanViewRegistry;
...
public class ExplainPlanViewer extends Viewer implements IAdaptable
{
            ...
            for (SQLPlanViewDescriptor viewDesc : instance.getPlanViewDescriptors()) {
                ...
                if (!CommonUtils.isEmpty(viewDesc.getDescription())) {
                    ...
                    if (viewDesc.getIcon() != null) {
                        treeViewButton.setImage(SQBaseIcons.getImage(viewDesc.getIcon()));
                    }
                }
    ...
    private class RefreshPlanAction extends Action {
        ...
        {
            super(SQLEditorMessages.editors_sql_explain_refresh_plan_action_text, SQBaseIcons.getImageDescriptor(UIIcon.REFRESH));
        }
