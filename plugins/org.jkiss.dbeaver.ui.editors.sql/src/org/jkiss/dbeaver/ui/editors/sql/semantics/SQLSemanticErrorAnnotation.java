...
import org.jkiss.sqbase.model.sql.semantics.SQLQueryRecognitionProblemInfo;
...
public class SQLSemanticErrorAnnotation extends MarkerAnnotation implements IAnnotationPresentation {
    ...
    public static final String MARKER_TYPE = "org.jkiss.sqbase.ui.editors.sql.semanticProblemMarker";
    public static final String MARKER_ATTRIBUTE_NAME = "org.jkiss.sqbase.ui.editors.sql.semantics.semanticProblemAnnotation";

    private static final Map<SQLQueryRecognitionProblemInfo.Severity, Image> imageByProblemSeverity = Map.of(
        SQLQueryRecognitionProblemInfo.Severity.ERROR, SQBaseIcons.getImage(DBIcon.TINY_ERROR),
        SQLQueryRecognitionProblemInfo.Severity.WARNING, SQBaseIcons.getImage(DBIcon.TINY_WARNING)
    );
