 ...
 */
package org.jkiss.sqbase.ui.editors.sql.generator;
...
import org.jkiss.sqbase.model.sql.generator.SQLGenerator;
import org.jkiss.sqbase.model.sql.generator.SQLGeneratorProcedureCall;
import org.jkiss.sqbase.model.sql.generator.SQLGeneratorSelect;
import org.jkiss.sqbase.model.sql.registry.SQLGeneratorConfigurationRegistry;
import org.jkiss.sqbase.model.sql.registry.SQLGeneratorDescriptor;
...
import org.jkiss.sqbase.ui.editors.sql.SQLEditorFeatures;
import org.jkiss.sqbase.ui.editors.sql.dialogs.ViewSQLDialog;
...
public class SQLGeneratorContributor extends CompoundContributionItem {
    ...
    private static ContributionItem makeAction(String text, SQLGeneratorDescriptor sqlGenerator, List<?> objects) {
        return new ActionContributionItem(
            new Action(text, SQBaseIcons.getImageDescriptor(DBIcon.SQL_TEXT)) {
                @Override
                public void run() {
