 ...
 */
package org.jkiss.sqbase.ui.editors.sql;
...
import org.jkiss.sqbase.ModelPreferences.SeparateConnectionBehavior;
...
import org.jkiss.sqbase.model.app.DBPWorkspaceDesktop;
import org.jkiss.sqbase.model.exec.*;
import org.jkiss.sqbase.model.exec.output.DBCOutputSeverity;
import org.jkiss.sqbase.model.exec.output.DBCOutputWriter;
import org.jkiss.sqbase.model.exec.output.DBCServerOutputReader;
...
import org.jkiss.sqbase.model.impl.DefaultServerOutputReader;
import org.jkiss.sqbase.model.impl.sql.BasicSQLDialect;
import org.jkiss.sqbase.model.messages.ModelMessages;
import org.jkiss.sqbase.model.navigator.NavigatorResources;
...
import org.jkiss.sqbase.model.runtime.DBRProgressListener;
...
import org.jkiss.sqbase.registry.confirmation.ConfirmationConstants;
...
import org.jkiss.sqbase.ui.*;
import org.jkiss.sqbase.ui.actions.datasource.DataSourceToolbarUtils;
import org.jkiss.sqbase.ui.controls.*;
import org.jkiss.sqbase.ui.controls.resultset.IResultSetController;
import org.jkiss.sqbase.ui.controls.resultset.IResultSetProvider;
import org.jkiss.sqbase.ui.controls.resultset.QueryResultsDecorator;
...
import org.jkiss.sqbase.ui.dialogs.ConfirmationDialog;
import org.jkiss.sqbase.ui.dialogs.EnterNameDialog;
import org.jkiss.sqbase.ui.editors.*;
import org.jkiss.sqbase.ui.editors.sql.addins.SQLEditorAddIn;
import org.jkiss.sqbase.ui.editors.sql.addins.SQLEditorAddInDescriptor;
import org.jkiss.sqbase.ui.editors.sql.addins.SQLEditorAddInsRegistry;
import org.jkiss.sqbase.ui.editors.sql.commands.MultipleResultsPerTabMenuContribution;
import org.jkiss.sqbase.ui.editors.sql.execute.SQLQueryJob;
import org.jkiss.sqbase.ui.editors.sql.handlers.SQLEditorVariablesResolver;
import org.jkiss.sqbase.ui.editors.sql.handlers.SQLNavigatorContext;
import org.jkiss.sqbase.ui.editors.sql.internal.SQLEditorActivator;
import org.jkiss.sqbase.ui.editors.sql.internal.SQLEditorMessages;
import org.jkiss.sqbase.ui.editors.sql.log.SQLLogPanel;
import org.jkiss.sqbase.ui.editors.sql.plan.ExplainPlanViewer;
import org.jkiss.sqbase.ui.editors.sql.registry.SQLPresentationDescriptor;
import org.jkiss.sqbase.ui.editors.sql.registry.SQLPresentationPanelDescriptor;
import org.jkiss.sqbase.ui.editors.sql.registry.SQLPresentationRegistry;
import org.jkiss.sqbase.ui.editors.sql.scripts.ScriptsHandlerImpl;
import org.jkiss.sqbase.ui.editors.sql.suggestion.SQLSuggestionTextPainter;
import org.jkiss.sqbase.ui.editors.sql.syntax.SQLEditorCompletionContext;
import org.jkiss.sqbase.ui.editors.sql.variables.AssignVariableAction;
import org.jkiss.sqbase.ui.editors.sql.variables.SQLVariablesPanel;
import org.jkiss.sqbase.ui.editors.text.DynamicFindReplaceTarget;
import org.jkiss.sqbase.ui.editors.text.ScriptPositionColumn;
    ...
    IStatefulEditor
{
    ...
    static final Image IMG_DATA_GRID = SQBaseIcons.getImage(UIIcon.SQL_PAGE_DATA_GRID);
    static final Image IMG_DATA_GRID_LOCKED = SQBaseIcons.getImage(UIIcon.SQL_PAGE_DATA_GRID_LOCKED);
    private static final Image IMG_EXPLAIN_PLAN = SQBaseIcons.getImage(UIIcon.SQL_PAGE_EXPLAIN_PLAN);
    private static final Image IMG_LOG = SQBaseIcons.getImage(UIIcon.SQL_PAGE_LOG);
    private static final Image IMG_VARIABLES = SQBaseIcons.getImage(UIIcon.SQL_VARIABLE);
    private static final Image IMG_OUTPUT = SQBaseIcons.getImage(UIIcon.SQL_PAGE_OUTPUT);
    private static final Image IMG_OUTPUT_ALERT = SQBaseIcons.getImage(UIIcon.SQL_PAGE_OUTPUT_ALERT);

    private static final String SIDE_TOP_TOOLBAR_CONTRIBUTION_ID = "toolbar:org.jkiss.sqbase.ui.editors.sql.toolbar.side.top";
    private static final String SIDE_BOTTOM_TOOLBAR_CONTRIBUTION_ID = "toolbar:org.jkiss.sqbase.ui.editors.sql.toolbar.side.bottom";

    private static final String MULTIPLE_RESULTS_PER_TAB_PROPERTY = "org.jkiss.sqbase.ui.editors.sql.multipleResultsPerTab.isEnabled";
    ...
    public static final String VIEW_PART_PROP_NAME = "org.jkiss.sqbase.ui.editors.sql.SQLEditor";
    ...
    private void createPresentationSwitchBar(Composite sqlEditorPanel) {
        ...
        switchPresentationSQLButton.setImage(SQBaseIcons.getImage(DBIcon.TREE_SCRIPT));
        ...
        if (STATS_CATEGORY_TRANSACTION_TIMEOUT.equals(category)) {
            ...
            if (field != null) {
                ...
                if (CommonUtils.isNotEmpty(status)) {
                    ...
                    field.setImage(SQBaseIcons.getImage(DBIcon.SMALL_WARNING));
                } else {
                    field.setText(null);
                    field.setImage(null);
                }
    ...
    private void updateExtraViewToolbar(IActionContributor actionContributor) {
        ...
        sqlExtraPanelToolbar.add(ActionUtils.makeCommandContribution(
            getSite(),
            "org.jkiss.sqbase.ui.editors.sql.toggle.extraPanels",
    ...
    private class PresentationPanelToggleAction extends Action {
        ...
        public PresentationPanelToggleAction(SQLPresentationPanelDescriptor panel) {
            ...
            if (panel.getIcon() != null) {
                setImageDescriptor(SQBaseIcons.getImageDescriptor(panel.getIcon()));
            }
        ...
        public void run() {
            ...
            if (panelInstance == null) {
                ...
                tabItem.setImage(SQBaseIcons.getImage(panel.getIcon()));
    ...
    protected void doSetInput(IEditorInput editorInput) throws CoreException {
        ...
        if (isNonPersistentEditor() && isDetectTitleImageFromInput()) {
            setTitleImage(SQBaseIcons.getImage(UIIcon.SQL_CONSOLE));
        }
    ...
    public void refreshEditorIconAndTitle() {
        ...
        if (bottomLeft != null || bottomRight != null) {
            ...
            editorImage = SQBaseIcons.getImage(image, false);
    ...
    public void editorContextMenuAboutToShow(IMenuManager menu) {
        ...
        if (!extraPresentationManager.presentations.isEmpty()) {
            for (Map.Entry<SQLPresentationDescriptor, SQLEditorPresentation> entry : extraPresentationManager.presentations.entrySet()) {
                ...
                menu.insertAfter(GROUP_SQL_EXTRAS, new Action(pd.getDescription(), SQBaseIcons.getImageDescriptor(pd.getIcon())) {
                    @Override
                    public void run() {
    ...
    public static class SQLEditorQueryListener implements SQLQueryListener {
        ...
        public void onStartQuery(@NotNull DBCSession session, @NotNull final SQLQuery query) {
            try {
                ...
                if (!isInExecute) {
                    UIUtils.asyncExec(() -> {
                        owner.setTitleImage(SQBaseIcons.getImage(UIIcon.SQL_SCRIPT_EXECUTE));
...
*/
    ...
    private class ConnectVisualizer extends UIJob {
        ...
        public IStatus runInUIThread(IProgressMonitor monitor) {
            ...
            if (!stopped) {
                setTitleImage(SQBaseIcons.getImage(UIIcon.LOADING.get(tickCount % UIIcon.LOADING.size())));
                schedule(100);
            } else {
                if (oldCursor != null) {
                    if (editorControl != null && !editorControl.isDisposed()) {
