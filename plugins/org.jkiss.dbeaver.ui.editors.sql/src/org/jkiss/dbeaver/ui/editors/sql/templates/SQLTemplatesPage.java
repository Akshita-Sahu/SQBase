...
import org.jkiss.sqbase.ui.ProxyPageSite;
import org.jkiss.sqbase.ui.editors.sql.SQLEditor;
import org.jkiss.sqbase.ui.editors.sql.SQLEditorBase;
import org.jkiss.sqbase.ui.editors.sql.SQLEditorSourceViewer;
import org.jkiss.sqbase.ui.editors.sql.SQLEditorSourceViewerConfiguration;
import org.jkiss.sqbase.ui.preferences.PreferenceStoreDelegate;
...
public class SQLTemplatesPage extends AbstractTemplatesPage {
    ...
    private static final String PREFERENCE_PAGE_ID = "org.jkiss.sqbase.ui.editors.sql.templates.SQLTemplatesPage"; //$NON-NLS-1$
    ...
    protected SourceViewer createPatternViewer(Composite parent) {
        ...
        //FIXME: reconciling is turned off here because it's a cause of deadlocks and severe UI glitches. The exact cause is unknown, find a more precise solution. [sqbase/sqbase#11452]
    ...
    {
        return SQBaseIcons.getImage(DBIcon.TREE_SCRIPT);
    }
