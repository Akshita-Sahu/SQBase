 ...
 */
package org.jkiss.sqbase.ui.controls.querylog;
...
import org.jkiss.sqbase.model.qm.*;
import org.jkiss.sqbase.model.qm.filters.QMCursorFilter;
import org.jkiss.sqbase.model.qm.filters.QMEventCriteria;
import org.jkiss.sqbase.model.qm.meta.*;
import org.jkiss.sqbase.model.runtime.DBRProgressMonitor;
import org.jkiss.sqbase.model.runtime.load.AbstractLoadService;
...
import org.jkiss.sqbase.registry.DataSourceProviderRegistry;
import org.jkiss.sqbase.runtime.DBWorkbench;
import org.jkiss.sqbase.runtime.qm.DefaultEventFilter;
import org.jkiss.sqbase.ui.*;
import org.jkiss.sqbase.ui.controls.ProgressLoaderVisualizer;
import org.jkiss.sqbase.ui.controls.TableColumnSortListener;
import org.jkiss.sqbase.ui.editors.TextEditorUtils;
import org.jkiss.sqbase.ui.editors.sql.SQLEditor;
import org.jkiss.sqbase.ui.editors.sql.SQLEditorUtils;
import org.jkiss.sqbase.ui.editors.sql.dialogs.BaseSQLDialog;
...
import org.jkiss.sqbase.ui.editors.sql.log.SQLLogFilter;
...
public class QueryLogViewer extends Viewer implements QMMetaListener, DBPPreferenceListener {
    ...
    private static final String QUERY_LOG_CONTROL_ID = "org.jkiss.sqbase.ui.qm.log"; //$NON-NLS-1$
    private static final String VIEWER_ID = "SQBase.QM.LogViewer"; //$NON-NLS-1$
    private static final String CMD_FILTER_ID = "org.jkiss.sqbase.core.qm.filter";
...
*/
    ...
    private void createContextMenu() {
        ...
        menuMgr.addMenuListener(manager -> {
            IAction editorAction = new Action("Open in SQL console", SQBaseIcons.getImageDescriptor(UIIcon.SQL_CONSOLE)) { //$NON-NLS-1$
                @Override
                public void run() {
    ...
    private class EventViewDialog extends BaseSQLDialog {
        ...
        private static final String DIALOG_ID = "SQBase.QM.EventViewDialog";//$NON-NLS-1$
