...
import org.jkiss.sqbase.ui.dialogs.AbstractPopupPanel;
import org.jkiss.sqbase.ui.editors.sql.SQLEditorUtils;
import org.jkiss.sqbase.ui.editors.sql.SQLEditorUtils.ResourceInfo;
...
public class ScriptSelectorPanel extends AbstractPopupPanel {
    ...
    private static final String DIALOG_ID = "SQBase.ScriptSelectorPopup";
        ...
        columnController.addColumn(
            ...
            new ColumnLabelProvider() {
                ...
                public Image getImage(Object element) {
                    ...
                    if (!ri.isDirectory()) {
                        if (ri.getDataSource() == null) {
                            ...
                            return SQBaseIcons.getImage(ri.getDataSource().getDriver().getIcon());
                        }
                    } else {
                        return SQBaseIcons.getImage(DBIcon.TREE_FOLDER);
                    }
                }
                ...
                public Image getToolTipImage(Object element) {
                    final DBPDataSourceContainer dataSource = ((ResourceInfo) element).getDataSource();
                    return dataSource == null ? null : SQBaseIcons.getImage(dataSource.getDriver().getIcon());
                }
            }
        );
