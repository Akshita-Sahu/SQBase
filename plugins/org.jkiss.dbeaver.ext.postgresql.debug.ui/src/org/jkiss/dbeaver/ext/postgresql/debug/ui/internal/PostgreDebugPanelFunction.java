...
package org.jkiss.sqbase.ext.postgresql.debug.ui.internal;
...
import org.jkiss.sqbase.debug.ui.DBGConfigurationPanel;
import org.jkiss.sqbase.debug.ui.DBGConfigurationPanelContainer;
...
import org.jkiss.sqbase.model.struct.rdb.DBSProcedureParameter;
...
import org.jkiss.sqbase.ui.controls.CSmartSelector;
    ...
    private void createFunctionGroup(Composite parent) {
        ...
        functionCombo = new CSmartSelector<>(functionGroup, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY, new LabelProvider() {
            ...
            public Image getImage(Object element) {
                return SQBaseIcons.getImage(DBIcon.TREE_PROCEDURE);
            }
