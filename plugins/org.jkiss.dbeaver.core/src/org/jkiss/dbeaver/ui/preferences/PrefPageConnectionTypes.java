...
import org.jkiss.sqbase.ui.dialogs.connection.EditConnectionPermissionsDialog;
...
public class PrefPageConnectionTypes extends AbstractPrefPage implements IWorkbenchPreferencePage, IWorkbenchPropertyPage {
    ...
    public static final String PAGE_ID = "org.jkiss.sqbase.preferences.connectionTypes"; //$NON-NLS-1$
    ...
    protected Control createPreferenceContent(@NotNull Composite parent) {
...

        {
            ...
            if (canEdit) {
                ...
                newButton.setImage(SQBaseIcons.getImage(UIIcon.ROW_ADD));
                deleteButton = new ToolItem(toolbar, SWT.NONE);
                deleteButton.setImage(SQBaseIcons.getImage(UIIcon.ROW_DELETE));
