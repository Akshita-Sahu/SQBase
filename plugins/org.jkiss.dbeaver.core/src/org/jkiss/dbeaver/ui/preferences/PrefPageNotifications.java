...
import org.jkiss.sqbase.ui.controls.CustomCheckboxCellEditor;
...
import org.jkiss.sqbase.ui.notifications.NotificationSettings;
import org.jkiss.sqbase.ui.notifications.NotificationUtils;
import org.jkiss.sqbase.ui.registry.NotificationDescriptor;
import org.jkiss.sqbase.ui.registry.NotificationRegistry;
...
public class PrefPageNotifications extends AbstractPrefPage implements IWorkbenchPreferencePage {
    ...
    protected Control createPreferenceContent(@NotNull Composite parent) {
...

        {
            ...
            longOperationsCheck = UIUtils.createCheckbox(
                ...
                preferences.getBoolean(SQBasePreferences.AGENT_LONG_OPERATION_NOTIFY),
                2
            );
            ...
            longOperationsTimeout = UIUtils.createLabelSpinner(
                ...
                preferences.getInt(SQBasePreferences.AGENT_LONG_OPERATION_TIMEOUT), 0, Integer.MAX_VALUE
            );
        }
    ...
    public boolean performOk() {
        ...
        preferences.setValue(SQBasePreferences.AGENT_LONG_OPERATION_NOTIFY, longOperationsCheck.getSelection());
        preferences.setValue(SQBasePreferences.AGENT_LONG_OPERATION_TIMEOUT, longOperationsTimeout.getSelection());
    ...
    protected void performDefaults() {
        ...
        longOperationsCheck.setSelection(preferences.getDefaultBoolean(SQBasePreferences.AGENT_LONG_OPERATION_NOTIFY));
        longOperationsTimeout.setSelection(preferences.getDefaultInt(SQBasePreferences.AGENT_LONG_OPERATION_TIMEOUT));
