...
import org.jkiss.sqbase.ui.controls.TextWithOpenFile;
...
{
    public static final String PAGE_ID = "org.jkiss.sqbase.preferences.main.errorLogs"; //$NON-NLS-1$
    ...
    protected Control createPreferenceContent(@NotNull Composite parent) {
...

        {
            ...
            logsDebugEnabled = UIUtils.createCheckbox(
                ...
                store.getBoolean(SQBasePreferences.LOGS_DEBUG_ENABLED),
                2);
            ...
            logsDebugLocation.setText(store.getString(SQBasePreferences.LOGS_DEBUG_LOCATION));
    ...
    protected void performDefaults() {
        DBPPreferenceStore store = DBWorkbench.getPlatform().getPreferenceStore();
        logsDebugEnabled.setSelection(store.getDefaultBoolean(SQBasePreferences.LOGS_DEBUG_ENABLED));
        logsDebugLocation.setText(store.getDefaultString(SQBasePreferences.LOGS_DEBUG_LOCATION));
    ...
    public boolean performOk() {
        ...
        store.setValue(SQBasePreferences.LOGS_DEBUG_ENABLED, logsDebugEnabled.getSelection());
        store.setValue(SQBasePreferences.LOGS_DEBUG_LOCATION, logsDebugLocation.getText());
