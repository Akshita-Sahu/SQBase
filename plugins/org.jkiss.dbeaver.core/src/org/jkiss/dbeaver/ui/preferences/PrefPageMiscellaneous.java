...
import org.jkiss.sqbase.ui.controls.DefaultColorSelector;
import org.jkiss.sqbase.ui.controls.TextWithDropDown;
import org.jkiss.sqbase.ui.controls.bool.BooleanMode;
import org.jkiss.sqbase.ui.controls.bool.BooleanState;
import org.jkiss.sqbase.ui.controls.bool.BooleanStyle;
...
public class PrefPageMiscellaneous extends PrefPageMiscellaneousAbstract implements IWorkbenchPreferencePage {
    ...
    protected Control createPreferenceContent(@NotNull Composite parent) {
...

        {
            ...
            holidayDecorationsCheck.setSelection(store.getBoolean(SQBasePreferences.UI_SHOW_HOLIDAY_DECORATIONS));
    ...
    protected void performDefaults() {
        ...
        holidayDecorationsCheck.setSelection(store.getDefaultBoolean(SQBasePreferences.UI_SHOW_HOLIDAY_DECORATIONS));
    ...
    public boolean performOk() {
        ...
        store.setValue(SQBasePreferences.UI_SHOW_HOLIDAY_DECORATIONS, holidayDecorationsCheck.getSelection());
        ...
        public BooleanPanel(@NotNull Composite parent, @NotNull BooleanState state, @NotNull String savedText) {
...

            {
                ...
                for (final UIElementAlignment alignment : UIElementAlignment.values()) {
                    ...
                    item.setImage(SQBaseIcons.getImage(alignment.getIcon()));
