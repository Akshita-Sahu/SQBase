...
public class PrefPageConnectionClient extends TargetPrefPage {
    public static final String PAGE_ID = "org.jkiss.sqbase.preferences.client.connections"; //$NON-NLS-1$
    ...
    private static final String[] ALLOWED_VARIABLES = new String[] {
        ...
        // We removed support of ${password} variable due to sqbase/pro#1861
