 ...
 */
package org.jkiss.sqbase.ui.controls.txn;
...
import org.jkiss.sqbase.ui.actions.datasource.DataSourceCommitHandler;
import org.jkiss.sqbase.ui.actions.datasource.DataSourceRollbackHandler;
...
public class PendingTransactionsDialog extends TransactionInfoDialog {
    ...
    private static final String DIALOG_ID = "SQBase.PendingTransactionsDialog";//$NON-NLS-1$
    ...
    protected Composite createDialogArea(Composite parent)
    {
...

        {
            ...
            commitButton = UIUtils.createPushButton(controlPanel, "Commit", SQBaseIcons.getImage(UIIcon.TXN_COMMIT));
            ...
            rollbackButton = UIUtils.createPushButton(controlPanel, "Rollback", SQBaseIcons.getImage(UIIcon.TXN_ROLLBACK));
    ...
    private void loadContexts(boolean showAllContexts) {
        ...
        for (DBPDataSourceContainer dataSource : DataSourceRegistry.getAllDataSources()) {
            ...
            for (DBSInstance instance : dataSource.getDataSource().getAvailableInstances()) {
                ...
                dsItem.setImage(SQBaseIcons.getImage(dataSource.getDriver().getIcon()));
