...
import org.jkiss.sqbase.ui.actions.AbstractPageListener;
import org.jkiss.sqbase.ui.controls.breadcrumb.BreadcrumbViewer;
import org.jkiss.sqbase.ui.editors.DatabaseEditorPreferences.BreadcrumbLocation;
import org.jkiss.sqbase.ui.editors.ILazyEditorInput;
import org.jkiss.sqbase.ui.editors.INavigatorEditorInput;
import org.jkiss.sqbase.ui.navigator.breadcrumb.NodeBreadcrumbViewer;

import java.util.function.Consumer;

public class BreadcrumbTrim {
    private static final String BREADCRUMBS_ID = "org.jkiss.sqbase.core.ui.Breadcrumb"; //$NON-NLS-1$
    ...
    private static void updateElementVisibility(@NotNull WorkbenchWindow window) {
        ...
        var statusLineVisible = store.getBoolean(SQBasePreferences.UI_STATUS_BAR_SHOW_STATUS_LINE);
    ...
    private static void installListeners(@NotNull BreadcrumbViewer viewer) {
        ...
        DBWorkbench.getPlatform().getPreferenceStore().addPropertyChangeListener(event -> {
            switch (event.getProperty()) {
                case SQBasePreferences.UI_STATUS_BAR_SHOW_BREADCRUMBS:
                case SQBasePreferences.UI_STATUS_BAR_SHOW_STATUS_LINE:
