...
import org.jkiss.sqbase.runtime.jobs.ConnectionTestJob;
import org.jkiss.sqbase.ui.ConnectionFeatures;
import org.jkiss.sqbase.ui.IDataSourceConnectionTester;
...
import org.jkiss.sqbase.ui.dialogs.IConnectionWizard;
...
//        return SQBaseIcons.getImage(selectedDriver == null ? DBIcon.DATABASE_DEFAULT : selectedDriver.getIcon());
    }
    ...
    public void testConnection() {
        ...
        if (canUseTemporaryDataSource(activeDataSource)) {
            ...
            int decision = ConfirmationDialog.confirmAction(
                ...
                SQBasePreferences.CONFIRM_TEST_CONNECTION_PERSIST,
