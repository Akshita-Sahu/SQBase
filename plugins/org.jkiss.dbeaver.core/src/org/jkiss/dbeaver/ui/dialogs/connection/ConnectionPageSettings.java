 ...
 */
package org.jkiss.sqbase.ui.dialogs.connection;
...
import org.jkiss.sqbase.model.connection.DBPDriverSubstitutionDescriptor;
import org.jkiss.sqbase.model.exec.DBCSession;
import org.jkiss.sqbase.model.net.DBWHandlerConfiguration;
import org.jkiss.sqbase.model.net.DBWHandlerDescriptor;
import org.jkiss.sqbase.model.net.DBWNetworkProfile;
import org.jkiss.sqbase.model.net.DBWUtils;
...
import org.jkiss.sqbase.registry.DataSourceViewDescriptor;
import org.jkiss.sqbase.registry.DataSourceViewRegistry;
import org.jkiss.sqbase.registry.driver.DriverDescriptor;
import org.jkiss.sqbase.registry.network.NetworkHandlerDescriptor;
...
import org.jkiss.sqbase.ui.dialogs.ActiveWizardPage;
...
import org.jkiss.sqbase.ui.dialogs.driver.DriverEditDialog;
...
class ConnectionPageSettings extends ActiveWizardPage<ConnectionWizard> implements IDataSourceConnectionEditorSite, IDialogPageProvider, ICompositeDialogPageContainer, IDataSourceConnectionTester {
    ...
    private ToolItem createHandlerItem(@NotNull ToolBar toolBar, @NotNull List<IDialogPage> pages) {
        ...
        toolItem.setImage(SQBaseIcons.getImage(UIIcon.ADD));
    ...
    private ToolItem createProfileItem(@NotNull ToolBar toolBar) {
        ...
        profileManager.addMenuListener(manager -> {
            ...
            manager.add(new Separator());
            manager.add(new Action("Edit profiles...", SQBaseIcons.getImageDescriptor(UIIcon.RENAME)) {
                @Override
                public void run() {
        ...
        toolItem.setImage(SQBaseIcons.getImage(DBIcon.TYPE_DOCUMENT));
    ...
    private void updateHandlerItem(@NotNull List<IDialogPage> allPages) {
        if (hasHandlersToAdd(allPages)) {
            ...
            handlerItem.setImage(SQBaseIcons.getImage(UIIcon.ADD));
    ...
    private boolean confirmTabClose(@NotNull CTabItem item) {
        if (item.getData() instanceof ConnectionPageNetworkHandler page) {
            ...
            final int decision = ConfirmationDialog.confirmAction(
                ...
                SQBasePreferences.CONFIRM_DISABLE_NETWORK_HANDLER,
    ...
    protected void updatePageCompletion() {
        for (CTabItem item : tabFolder.getItems()) {
            ...
            if (complete || tabFolder.getSelection() == item) {
                ...
                item.setImage(SQBaseIcons.getImage(DBIcon.SMALL_ERROR));
