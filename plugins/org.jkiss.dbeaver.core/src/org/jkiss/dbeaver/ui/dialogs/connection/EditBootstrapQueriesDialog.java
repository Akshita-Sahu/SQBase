...
public class EditBootstrapQueriesDialog extends HelpEnabledDialog {
    ...
    private static final String DIALOG_ID = "SQBase.EditBootstrapQueriesDialog";
    ...
    protected IDialogSettings getDialogBoundsSettings() {
        return UIUtils.getSettingsSection(SQBaseActivator.getInstance().getDialogSettings(), DIALOG_ID);
    }
