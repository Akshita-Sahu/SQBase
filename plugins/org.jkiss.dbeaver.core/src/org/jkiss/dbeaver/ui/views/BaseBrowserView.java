...
package org.jkiss.sqbase.ui.views;
...
public class BaseBrowserView extends ViewPart {
    ...
    private Action backAction = new Action("Back", SQBaseIcons.getImageDescriptor(UIIcon.RS_BACK)) {
        @Override
        public void run() {
            browser.back();
        }
    ...
    private Action forwardAction = new Action("Forward", SQBaseIcons.getImageDescriptor(UIIcon.RS_FORWARD)) {
        @Override
        public void run() {
            browser.forward();
        }
    ...
    private Action stopAction = new Action("Stop", SQBaseIcons.getImageDescriptor(UIIcon.REJECT)) {
        @Override
        public void run() {
            browser.stop();
        }
    ...
    private Action refreshAction = new Action("Refresh", SQBaseIcons.getImageDescriptor(UIIcon.REFRESH)) {
        @Override
        public void run() {
            browser.refresh();
        }
