...
import org.jkiss.sqbase.ui.ConnectionLabelUtils;
import org.jkiss.sqbase.ui.UIExecutionQueue;
import org.jkiss.sqbase.ui.editors.EditorUtils;

import java.util.WeakHashMap;

public final class SQBaseEditorPartUtils {
    private static final Log log = Log.getLog(SQBaseEditorPartUtils.class);

    private static final String PART_SKIP_KEY = SQBaseEditorPartUtils.class.getName() + ".skipPart";
    private static final String PART_INPUT_INITIALIZED = SQBaseEditorPartUtils.class.getName() + ".inputInitialized";
