...
import org.jkiss.sqbase.ui.SearchCellLabelProvider;
import org.jkiss.sqbase.ui.UIUtils;

import java.lang.reflect.Method;

public class SQBasePartList extends BasicPartList {
    private static final Log log = Log.getLog(SQBasePartList.class);

    private final StackRenderer renderer;

    public SQBasePartList(
    ...
    private class CellLabelProvider extends SearchCellLabelProvider {
        ...
        private DBPDataSourceContainer resolveContainer(@NotNull Object element) {
            ...
            return SQBaseEditorPartUtils.getDataSourceContainer(part);
        }
        ...
        public String getPattern() {
            return SQBasePartList.this.getPattern();
        }
