...
import org.jkiss.sqbase.core.CoreCommands;
...
import org.jkiss.sqbase.ui.actions.common.AddBookmarkHandler;
...
import org.jkiss.sqbase.ui.editors.sql.SQLEditorCommands;
import org.jkiss.sqbase.ui.editors.sql.SQLEditorUtils;
import org.jkiss.sqbase.ui.editors.sql.handlers.SQLEditorHandlerRenameFile;
...
public class SQBaseStackRenderer extends StackRenderer {

    private static final Log log = Log.getLog(SQBaseStackRenderer.class);
    ...
    public void showAvailableItems(MElementContainer<?> stack, CTabFolder folder, boolean forceCenter) {
        ...
        final SQBasePartList list = new SQBasePartList(
            folder.getShell(),
            SWT.ON_TOP,
