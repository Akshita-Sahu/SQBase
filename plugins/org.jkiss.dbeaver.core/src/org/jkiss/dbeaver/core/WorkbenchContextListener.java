...
import org.jkiss.sqbase.ui.actions.datasource.DataSourceToolbarHandler;
import org.jkiss.sqbase.ui.editors.EditorUtils;
import org.jkiss.sqbase.ui.editors.NodeEditorInput;
...
public class WorkbenchContextListener implements IWindowListener, IPageListener, IPartListener {
    ...
    public static final String PERSPECTIVE_CONTEXT_ID = "org.jkiss.sqbase.ui.perspective";
    ...
    private void listenWindowEvents(IWorkbenchWindow window) {
        ...
        IPerspectiveListener perspectiveListener = new IPerspectiveListener() {
            ...
            public void perspectiveActivated(IWorkbenchPage page, IPerspectiveDescriptor perspective) {
                ...
                if (perspective.getId().equals(SQBasePerspective.PERSPECTIVE_ID)) {
