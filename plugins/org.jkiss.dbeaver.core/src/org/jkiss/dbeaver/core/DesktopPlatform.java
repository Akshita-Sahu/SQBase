...
import org.jkiss.sqbase.model.navigator.DesktopNavigatorModel;
...
import org.jkiss.sqbase.runtime.SecurityProviderUtils;
...
public class DesktopPlatform extends BasePlatformImpl implements DBPPlatformDesktop {
    ...
    // The plug-in ID
    public static final String PLUGIN_ID = "org.jkiss.sqbase.core"; //$NON-NLS-1$
    ...
    protected void initialize() {
        ...
        if (getPreferenceStore().getBoolean(SQBasePreferences.SECURITY_USE_BOUNCY_CASTLE)) {
        ...
        this.certificateStorage = new DefaultCertificateStorage(
            this,
            RuntimeUtils.getPluginStateLocation(SQBaseActivator.getInstance())
    ...
    protected Plugin getProductPlugin() {
        return SQBaseActivator.getInstance();
    }
