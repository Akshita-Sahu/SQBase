...
import org.jkiss.sqbase.model.runtime.RunnableWithResult;
...
import org.jkiss.sqbase.ui.editors.EditorPartContextualProperty;
import org.jkiss.sqbase.ui.editors.EditorPartContextualProperty.PartCustomPropertyValueInfo;
import org.jkiss.sqbase.ui.editors.sql.SQLEditor;
import org.jkiss.sqbase.ui.editors.sql.SQLEditorListener;
import org.jkiss.sqbase.ui.editors.sql.SQLEditorListenerDefault;
import org.jkiss.sqbase.ui.editors.sql.addins.SQLEditorAddIn;
import org.jkiss.sqbase.ui.editors.sql.terminal.internal.SQLTerminalMessages;
...
public class SQLTerminalEditorAddIn implements SQLEditorAddIn {
    ...
    private static final String BUNDLE_NAME = "org.jkiss.sqbase.ui.editors.sql.terminal";

    private static final String TERMINAL_VIEW_ENABLED_PROPERTY = "org.jkiss.sqbase.ui.editors.sql.show.consoleView.isEnabled";
    ...
    private class TerminalViewContext {
        ...
        public TerminalViewContext() {
            ...
            tabItem.setImage(SQBaseIcons.getImage(UIIcon.SQL_CONSOLE));
