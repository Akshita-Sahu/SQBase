 ...
 */
package org.jkiss.sqbase.ui.properties;
...
import org.jkiss.sqbase.ui.controls.bool.BooleanStyleDecorator;
    ...
    public void saveEditorValues() {
        if (RuntimeUtils.isMacOS() && curCellEditor != null && curCellEditor.isActivated()) {
            try {
                ...
                // See:
                // https://github.com/sqbase/sqbase/issues/3553
                // https://github.com/sqbase/sqbase/issues/10366
                // https://github.com/sqbase/sqbase/issues/10361
