...
import org.jkiss.sqbase.model.connection.DBPConnectionType;
import org.jkiss.sqbase.model.exec.DBCExecutionContext;
import org.jkiss.sqbase.model.exec.DBCExecutionContextDefaults;
import org.jkiss.sqbase.model.runtime.*;
import org.jkiss.sqbase.runtime.DBWorkbench;
import org.jkiss.sqbase.runtime.DummyRunnableContext;
import org.jkiss.sqbase.runtime.RunnableContextDelegate;
import org.jkiss.sqbase.ui.contentassist.ContentAssistUtils;
import org.jkiss.sqbase.ui.contentassist.SmartTextContentAdapter;
import org.jkiss.sqbase.ui.contentassist.StringContentProposalProvider;
import org.jkiss.sqbase.ui.controls.CustomSashForm;
import org.jkiss.sqbase.ui.controls.ExpandableCompositeEx;
import org.jkiss.sqbase.ui.controls.TitledComposite;
import org.jkiss.sqbase.ui.dialogs.EditTextDialog;
import org.jkiss.sqbase.ui.dialogs.MessageBoxBuilder;
import org.jkiss.sqbase.ui.dialogs.Reply;
import org.jkiss.sqbase.ui.internal.UIActivator;
...
public class UIUtils {
    ...
    private static final String INLINE_WIDGET_EDITOR_ID = "org.jkiss.sqbase.ui.InlineWidgetEditor";
    ...
    public static void createToolBarSeparator(ToolBar toolBar, int style) {
        ...
        label.setImage(SQBaseIcons.getImage((style & SWT.HORIZONTAL) == SWT.HORIZONTAL ? UIIcon.SEPARATOR_H : UIIcon.SEPARATOR_V));
    ...
    public static Label createLabel(Composite parent, @NotNull DBPImage image) {
        ...
        imageLabel.setImage(SQBaseIcons.getImage(image));
    ...
    public static Control createWarningLabel(
        ...
        return createInfoLabel(parent, text, gridStyle, hSpan, null, SQBaseIcons.getImage(DBIcon.SMALL_WARNING));
    }
    ...
    public static Control createInfoLabel(
        ...
        return createInfoLabel(parent, text, gridStyle, hSpan, callback, SQBaseIcons.getImage(DBIcon.SMALL_INFO));
    }
    ...
    public static Link createInfoLink(
        ...
        imageLabel.setImage(SQBaseIcons.getImage(DBIcon.SMALL_INFO));
    ...
    public static Text createLabelTextAdvanced(@NotNull Composite parent, @NotNull String label, @Nullable String value, int style) {
        ...
        //editButton.setText("...");
        editButton.setImage(SQBaseIcons.getImage(UIIcon.EDIT)); //$NON-NLS-1$
    ...
    public static ToolItem createToolItem(ToolBar parent, String text, DBPImage icon, SelectionListener selectionListener) {
        return createToolItem(parent, text, icon != null ? SQBaseIcons.getImage(icon) : null, selectionListener);
    }
    ...
    public static ToolItem createToolItem(ToolBar parent, String title, String text, DBPImage icon, SelectionListener selectionListener) {
        ToolItem toolItem = createToolItem(parent, text, icon != null ? SQBaseIcons.getImage(icon) : null, selectionListener);
        if (title != null) {
    ...
    public static Button createPushButton(
        ...
        if (image != null) {
            button.setImage(SQBaseIcons.getImage(image));
        }
        if (selectionListener != null) {
            button.addSelectionListener(selectionListener);
        }
    ...
    public static Button createDialogButton(
        ...
        if (icon != null) {
            button.setImage(SQBaseIcons.getImage(icon));
        }
        if (toolTip != null) {
            button.setToolTipText(toolTip);
        }
    ...
    private static boolean mainFontIsDefault() {
        final FontData[] mainFontData = JFaceResources.getFontRegistry().getFontData(UIFonts.SQBase.MAIN_FONT);
    ...
    public static void populateToolItemCommandIds(ToolBarManager toolbarManager) {
        // used for accessibility automation, see qa-auto-sqbase
        ToolBar toolBar = toolbarManager.getControl();
        if (toolBar == null || toolBar.isDisposed()) {
            return;
        }
