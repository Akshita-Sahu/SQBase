...
//        }
    ...
    public void setCompleteMarkAfterProgress() {
        ...
        selectedItem.setImage(SQBaseIcons.getImage(UIIcon.OK_MARK));
    }
    ...
    private void updatePageCompleteMark(TreeItem parent) {
        ...
        for (TreeItem item : parent == null ? pagesTree.getItems() : parent.getItems()) {
            ...
            if (isShowTreeIcons()) {
                ...
                item.setImage(itemImage == null ? null : SQBaseIcons.getImage(itemImage));
            }
    ...
    public void updateWindowTitle() {
        ...
        if (shell != null) {
            ...
            //getShell().setImage(getWizard().getDefaultPageImage());//SQBaseIcons.getImage(activeDataSource.getObjectImage()));
