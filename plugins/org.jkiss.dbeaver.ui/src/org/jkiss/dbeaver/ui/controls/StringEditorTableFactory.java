...
public class StringEditorTableFactory<T> {
    ...
    protected void fillItems() {
        ...
        if (!CommonUtils.isEmpty(values)) {
            for (T value : values) {
                ...
                tableItem.setImage(icon == null ? null : SQBaseIcons.getImage(icon));
            }
        }
    }
        ...
        return new CustomTableEditor(valueTable) {
            ...
            protected void saveEditorValue(Control control, int index, TableItem item) {
                ...
                if (value != null) {
                    ...
                    DBPImage icon = valuesManager.getIcon(value);
                    item.setImage(icon == null ? null : SQBaseIcons.getImage(icon));
                }
            }
        };
    }
    ...
    protected void addTableItem(@NotNull TableItem newItem) {
        ...
        newItem.setImage(icon == null ? null : SQBaseIcons.getImage(icon));
    ...
    protected Control upButton(@NotNull Composite buttonsGroup) {
        ...
        upButton.setImage(SQBaseIcons.getImage(UIIcon.ARROW_UP));
    ...
    protected Control downButton(@NotNull Composite buttonsGroup) {
        ...
        downButton.setImage(SQBaseIcons.getImage(UIIcon.ARROW_DOWN));
