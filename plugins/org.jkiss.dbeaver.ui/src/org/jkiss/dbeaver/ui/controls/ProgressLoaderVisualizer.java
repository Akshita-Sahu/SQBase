...
public class ProgressLoaderVisualizer<RESULT> implements ILoadVisualizer<RESULT>
{
    ...
    private void showProgress() {
        ...
        if (progressOverlay == null) {
            ...
            gd.verticalIndent = SQBaseIcons.getImage(UIIcon.PROGRESS0).getBounds().height * 2;
            ...
            painListener = e -> {
                ...
                Image image = SQBaseIcons.getImage(PROGRESS_IMAGES[drawCount % PROGRESS_IMAGES.length]);
