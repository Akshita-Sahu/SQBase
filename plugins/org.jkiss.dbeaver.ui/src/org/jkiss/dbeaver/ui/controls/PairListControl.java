...
public class PairListControl<ELEMENT> extends Composite
{
    ...
    private void createPairList(String leftTitle, String rightTitle)
    {
...

        {
            ...
            final Button btnMoveRight = createButton(buttonsPane, SQBaseIcons.getImage(UIIcon.ARROW_RIGHT), new SelectionAdapter() {
                @Override
                public void widgetSelected(SelectionEvent e) {
                    moveElements(true);
                }
            });
            final Button btnMoveRightAll = createButton(buttonsPane, SQBaseIcons.getImage(UIIcon.ARROW_RIGHT_ALL), new SelectionAdapter() {
                @Override
                public void widgetSelected(SelectionEvent e) {
                    leftList.selectAll();
                    moveElements(true);
            ...
            final Button btnMoveLeft = createButton(buttonsPane, SQBaseIcons.getImage(UIIcon.ARROW_LEFT), new SelectionAdapter() {
                @Override
                public void widgetSelected(SelectionEvent e) {
                    moveElements(false);
                }
            });
            final Button btnMoveLeftAll = createButton(buttonsPane, SQBaseIcons.getImage(UIIcon.ARROW_LEFT_ALL), new SelectionAdapter() {
                @Override
                public void widgetSelected(SelectionEvent e) {
                    rightList.selectAll();
                    moveElements(false);
            ...
            createButton(buttonsPane, SQBaseIcons.getImage(UIIcon.ARROW_RESET), new SelectionAdapter() {
                @Override
                public void widgetSelected(SelectionEvent e) {
