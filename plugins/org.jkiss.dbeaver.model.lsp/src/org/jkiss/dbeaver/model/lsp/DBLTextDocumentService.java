 ...
 */
package org.jkiss.sqbase.model.lsp;
...
import org.jkiss.sqbase.model.lsp.context.ContextAwareDocument;
import org.jkiss.sqbase.model.lsp.context.LspSQLCompletionContext;
import org.jkiss.sqbase.model.lsp.context.LspSQLCompletionContextParser;
import org.jkiss.sqbase.model.lsp.context.LspSQLRuleManager;
import org.jkiss.sqbase.model.lsp.utils.LSPUtils;
...
import org.jkiss.sqbase.model.sql.format.SQLFormatterConfiguration;
...
public class DBLTextDocumentService implements TextDocumentService, LanguageClientAware {
    ...
    private void initContext(@NotNull DocumentURI documentUri) {
        ...
        if (project != null) {
            ...
            // in Clousqbase - from front-end - LocalResourceController#setResourceProperty
