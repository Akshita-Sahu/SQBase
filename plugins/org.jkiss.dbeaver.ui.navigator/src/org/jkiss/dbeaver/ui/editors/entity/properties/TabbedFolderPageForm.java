 ...
 */
package org.jkiss.sqbase.ui.editors.entity.properties;
...
import org.jkiss.sqbase.model.edit.prop.DBECommandProperty;
...
import org.jkiss.sqbase.ui.ICustomActionsProvider;
import org.jkiss.sqbase.ui.IRefreshablePart;
...
import org.jkiss.sqbase.ui.controls.ObjectEditorPageControl;
import org.jkiss.sqbase.ui.controls.folders.TabbedFolderPage;
...
/*
        contributionManager.add(new Action(isAttached() ? "Detach properties to top panel" : "Move properties to tab", SQBaseIcons.getImageDescriptor(UIIcon.ASTERISK)) {
            @Override
            public void run() {
