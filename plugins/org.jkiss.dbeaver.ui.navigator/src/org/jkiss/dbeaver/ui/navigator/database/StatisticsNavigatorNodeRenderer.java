...
import org.jkiss.sqbase.ui.internal.registry.NavigatorExtensionsRegistry;
import org.jkiss.sqbase.ui.navigator.INavigatorModelView;
import org.jkiss.sqbase.ui.navigator.INavigatorNodeActionHandler;
...
public class StatisticsNavigatorNodeRenderer extends DefaultNavigatorNodeRenderer {
    ...
    private void drawDataSourceActions(
        ...
        for (INavigatorNodeActionHandler action : actions) {
            Image image = SQBaseIcons.getImage(action.getNodeActionIcon(getView(), node));
