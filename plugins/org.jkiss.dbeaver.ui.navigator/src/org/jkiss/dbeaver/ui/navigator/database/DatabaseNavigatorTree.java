...
import org.jkiss.sqbase.registry.RuntimeProjectPropertiesConstant;
import org.jkiss.sqbase.runtime.DBWorkbench;
import org.jkiss.sqbase.ui.*;
import org.jkiss.sqbase.ui.controls.ProgressPainter;
import org.jkiss.sqbase.ui.navigator.INavigatorFilter;
import org.jkiss.sqbase.ui.navigator.INavigatorItemRenderer;
import org.jkiss.sqbase.ui.navigator.NavigatorCommands;
import org.jkiss.sqbase.ui.navigator.NavigatorPreferences;
import org.jkiss.sqbase.ui.navigator.actions.NavigatorHandlerObjectRename;
...
public class DatabaseNavigatorTree extends Composite implements INavigatorListener {
    ...
    private static final String FILTER_TOOLBAR_CONNECTED_CONTRIBUTION_ID = "toolbar:org.jkiss.sqbase.navigator.filter.toolbar.connected"; //$NON-NLS-1$
    private static final String FILTER_TOOLBAR_TYPE_CONTRIBUTION_ID = "toolbar:org.jkiss.sqbase.navigator.filter.toolbar.type"; //$NON-NLS-1$
...
*/
    ...
    private class NodeLoadersPainter extends UIJob {
        ...
        private Image getCurrentImage() {
            ...
            return SQBaseIcons.getImage(UIIcon.LOADING.get(imgIndex));
        }
