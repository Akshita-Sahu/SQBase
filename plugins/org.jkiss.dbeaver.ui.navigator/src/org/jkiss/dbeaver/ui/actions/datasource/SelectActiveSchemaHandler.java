...
import org.jkiss.sqbase.model.impl.struct.ContextDefaultObjectsReader;
...
import org.jkiss.sqbase.ui.editors.DatabaseLazyEditorInput;
...
import org.jkiss.sqbase.ui.navigator.dialogs.SelectDatabaseDialog;
...
public class SelectActiveSchemaHandler extends AbstractDataSourceHandler implements IElementUpdater {
    ...
    public void updateElement(UIElement element, Map parameters) {
        ...
        element.setIcon(SQBaseIcons.getImageDescriptor(schemaIcon));
            ...
            for (DBNDatabaseNode node : contextDefaultObjectsReader.getNodeList()) {
                menuItems.add(
                    new ActionContributionItem(new Action(node.getName(), Action.AS_CHECK_BOX) {
                        ...
                        {
                            setImageDescriptor(SQBaseIcons.getImageDescriptor(node.getNodeIcon()));
                        }
                        @Override
