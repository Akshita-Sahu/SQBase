...
public class DataSourceToolbarUtils {
    ...
    public static final String CONNECTION_SELECTOR_TOOLBAR_ID = "sqbase-connection-selector";
    ...
    public static void updateCommandsUI() {
        ...
        if (commandService != null) {
            ...
            //commandService.refreshElements("org.jkiss.sqbase.ui.editors.sql.sync.connection", null);
        }
    }
