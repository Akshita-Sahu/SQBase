...
import org.jkiss.sqbase.ext.oracle.internal.OracleMessages;
import org.jkiss.sqbase.ext.oracle.model.plan.OracleQueryPlanner;
import org.jkiss.sqbase.ext.oracle.model.session.OracleServerSessionManager;
...
import org.jkiss.sqbase.model.data.DBDAttributeContentTypeProvider;
import org.jkiss.sqbase.model.data.DBDPseudoAttribute;
import org.jkiss.sqbase.model.data.DBDPseudoAttributeContainer;
import org.jkiss.sqbase.model.data.DBDPseudoAttributeType;
            ...
            if (planTableName == null) {
                ...
                if (!DBWorkbench.getPlatformUI().confirmAction(
                    ...
                    "PLAN_TABLE not found in current user's session. " +
                        "Do you want SQBase to create new PLAN_TABLE (" + newPlanTableName + ")?")) {
                    return null;
                }
