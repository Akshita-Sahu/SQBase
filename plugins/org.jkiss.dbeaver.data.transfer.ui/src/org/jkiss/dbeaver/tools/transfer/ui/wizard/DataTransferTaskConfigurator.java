...
import org.jkiss.sqbase.model.impl.DataSourceContextProvider;
...
import org.jkiss.sqbase.model.task.DBTTaskType;
import org.jkiss.sqbase.runtime.DBWorkbench;
import org.jkiss.sqbase.runtime.ui.UIServiceSQL;
import org.jkiss.sqbase.tasks.ui.DBTTaskConfigPanel;
import org.jkiss.sqbase.tasks.ui.DBTTaskConfigPanelProvider;
...
import org.jkiss.sqbase.ui.UIWidgets;
import org.jkiss.sqbase.ui.navigator.NavigatorUtils;
import org.jkiss.sqbase.ui.navigator.dialogs.ObjectBrowserDialog;
...
public class DataTransferTaskConfigurator implements DBTTaskConfigurator, DBTTaskConfigPanelProvider {
    ...
    private static class ConfigPanel implements DBTTaskConfigPanel {
        ...
        private void addPipeToTable(DataTransferPipe pipe) {
            ...
            item.setData(pipe);
            item.setImage(0, SQBaseIcons.getImage(node.getObjectIcon()));
            ...
            if (node.getDataSourceContainer() != null) {
                ...
                if (dsIcon != null) {
                    item.setImage(1, SQBaseIcons.getImage(dsIcon));
                }
            }
