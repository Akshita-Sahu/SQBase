        ...
        for (int i = 0; i < dataPipes.size(); i++) {
            ...
            if (producer != null) {
                ...
                if (producer.getObjectContainerIcon() != null) {
                    item.setImage(0, SQBaseIcons.getImage(producer.getObjectContainerIcon()));
                }
                ...
                if (producerObjectIcon != null) {
                    item.setImage(1, SQBaseIcons.getImage(producerObjectIcon));
                }
            ...
            if (consumer != null) {
                ...
                if (consumer.getObjectContainerIcon() != null) {
                    item.setImage(2, SQBaseIcons.getImage(consumer.getObjectContainerIcon()));
                }
                ...
                if (consumerObjectIcon != null) {
                    item.setImage(3, SQBaseIcons.getImage(consumerObjectIcon));
                }
