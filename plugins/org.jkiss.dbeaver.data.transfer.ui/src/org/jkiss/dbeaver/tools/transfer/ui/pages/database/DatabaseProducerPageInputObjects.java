...
import org.jkiss.sqbase.model.runtime.DefaultProgressMonitor;
...
import org.jkiss.sqbase.tools.transfer.IDataTransferSettings;
...
public class DatabaseProducerPageInputObjects extends DataTransferPageNodeSettings {
    ...
    public void createControl(Composite parent) {
        ...
        }
        {
            ...
            autoAssignButton.setImage(SQBaseIcons.getImage(UIIcon.ASTERISK));
    ...
    private void updateItemData(TableItem item, DataTransferPipe pipe) {
        ...
        if (pipe.getProducer() == null || pipe.getProducer().getDatabaseObject() == null) {
            ...
            item.setImage(0, SQBaseIcons.getImage(settings.getProducer().getIcon()));
        ...
        if (pipe.getConsumer() == null || pipe.getConsumer().getObjectName() == null) {
            ...
            updateConsumerContainer(pipe);
            item.setImage(1, SQBaseIcons.getImage(settings.getConsumer().getIcon()));
