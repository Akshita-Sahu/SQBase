...
import org.jkiss.sqbase.ui.dialogs.BaseProgressDialog;
...
class PreviewMappingDialog extends BaseProgressDialog {
    ...
    private static final String DIALOG_ID = "SQBase.DataTransfer.PreviewMappingDialog";
        ...
        UIUtils.asyncExec(() -> {
            ...
            try {
                ...
                for (DatabaseTransferConsumer.ColumnMapping columnMapping : previewConsumer.getColumnMappings()) {
                    ...
                    column.setImage(SQBaseIcons.getImage(DBValueFormatting.getObjectImage(attr)));
