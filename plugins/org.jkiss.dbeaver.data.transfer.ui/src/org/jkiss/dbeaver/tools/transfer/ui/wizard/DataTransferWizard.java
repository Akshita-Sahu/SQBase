 ...
 */
package org.jkiss.sqbase.tools.transfer.ui.wizard;
...
import org.jkiss.sqbase.tasks.ui.wizard.TaskProcessorUI;
import org.jkiss.sqbase.tools.transfer.*;
import org.jkiss.sqbase.tools.transfer.database.DatabaseTransferProducer;
import org.jkiss.sqbase.tools.transfer.internal.DTMessages;
import org.jkiss.sqbase.tools.transfer.registry.DataTransferNodeDescriptor;
...
import org.jkiss.sqbase.tools.transfer.task.DTTaskHandlerTransfer;
import org.jkiss.sqbase.tools.transfer.ui.dialog.DataTransferConfigurationWizardDialog;
import org.jkiss.sqbase.tools.transfer.ui.internal.DTUIActivator;
...
import org.jkiss.sqbase.tools.transfer.ui.registry.DataTransferConfiguratorRegistry;
import org.jkiss.sqbase.tools.transfer.ui.registry.DataTransferNodeConfiguratorDescriptor;
import org.jkiss.sqbase.tools.transfer.ui.registry.DataTransferPageDescriptor;
import org.jkiss.sqbase.tools.transfer.ui.registry.DataTransferPageType;
import org.jkiss.sqbase.ui.DialogSettingsMap;
...
public class DataTransferWizard extends TaskConfigurationWizard<DataTransferSettings> implements IExportWizard, IImportWizard {
    ...
    private static final String CLI_ARG_DEBUG_DISABLE_DT_SETTINGS_SAVE = "sqbase.debug.disable-data-transfer-settings-save";
...
*/
    ...
    private Map<String, Object> saveConfiguration(@NotNull Map<String, Object> config) {
        ...
        String property = System.getProperty(CLI_ARG_DEBUG_DISABLE_DT_SETTINGS_SAVE); // Turn off processor settings save. For Testing only. Use it after vmargs -Dsqbase.debug.disable-data-transfer-settings-save=true
