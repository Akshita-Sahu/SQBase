...
import org.jkiss.sqbase.model.app.DBPDataFormatterRegistry;
import org.jkiss.sqbase.model.app.DBPPlatformDesktop;
import org.jkiss.sqbase.model.data.DBDDataFormatterProfile;
...
import org.jkiss.sqbase.tools.transfer.stream.*;
...
import org.jkiss.sqbase.ui.SharedTextColors;
import org.jkiss.sqbase.ui.UIUtils;
import org.jkiss.sqbase.ui.controls.CustomComboBoxCellEditor;
import org.jkiss.sqbase.ui.controls.TreeContentProvider;
import org.jkiss.sqbase.ui.controls.ValueFormatSelector;
import org.jkiss.sqbase.ui.dialogs.BaseDialog;
...
public class StreamConsumerPageSettings extends DataTransferPageNodeSettings {
                ...
                new SelectionAdapter() {
                    ...
                    public void widgetSelected(SelectionEvent e) {
                        PreferenceDialog propDialog = PreferencesUtil.createPropertyDialogOn(
                            ...
                            "org.jkiss.sqbase.preferences.main.dataformat", // TODO: replace this hardcode with some model invocation
                            null,
    ...
    private static class ConfigureColumnsPopup extends BaseDialog {
        ...
        protected Composite createDialogArea(@NotNull Composite parent) {
...

            {
                ...
                column.setLabelProvider(new CellLabelProvider() {
                    ...
                    public void update(ViewerCell cell) {
                        ...
                        cell.setImage(SQBaseIcons.getImage(DBValueFormatting.getObjectImage(object)));
                    }
                });
            ...
            errorLabel.setImage(SQBaseIcons.getImage(DBIcon.SMALL_ERROR));
