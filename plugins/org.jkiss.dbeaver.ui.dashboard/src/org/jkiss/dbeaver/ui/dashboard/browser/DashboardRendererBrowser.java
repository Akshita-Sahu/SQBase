 ...
 */
package org.jkiss.sqbase.ui.dashboard.browser;
...
import org.jkiss.sqbase.ui.dashboard.control.DashboardRendererAbstract;
...
public class DashboardRendererBrowser extends DashboardRendererAbstract {
    ...
    public void fillDashboardToolbar(
        ...
        manager.add(new Action("Open in external browser", SQBaseIcons.getImageDescriptor(UIIcon.LINK)) {
            @Override
            public void run() {
