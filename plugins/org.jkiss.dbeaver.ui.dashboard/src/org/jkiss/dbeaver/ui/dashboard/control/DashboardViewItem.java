...
import org.jkiss.sqbase.model.dashboard.DBDashboardMapQuery;
import org.jkiss.sqbase.model.dashboard.DBDashboardQuery;
import org.jkiss.sqbase.model.dashboard.DashboardIcons;
...
import org.jkiss.sqbase.ui.dashboard.model.*;
...
import static org.jkiss.sqbase.ui.dashboard.DashboardUIConstants.PARAM_CATALOG_PANEL_TOGGLE;
...
public class DashboardViewItem extends Composite implements DashboardItemContainer {
    ...
    public DashboardViewItem(@NotNull DashboardListControl parent, @NotNull DashboardItemConfiguration item) {
...

        {
            ...
            titleIcon.setImage(SQBaseIcons.getImage(icon));
        ...
        if (!UIUtils.isInDialog(dashboardControl) && viewTypes.size() > 1) {
            ...
            for (DashboardRendererType viewType : viewTypes) {
                ...
                if (viewType.getIcon() != null) {
                    changeViewAction.setImageDescriptor(SQBaseIcons.getImageDescriptor(viewType.getIcon()));
                }
