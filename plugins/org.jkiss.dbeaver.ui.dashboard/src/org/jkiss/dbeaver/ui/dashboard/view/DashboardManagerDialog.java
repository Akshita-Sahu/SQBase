 ...
 */
package org.jkiss.sqbase.ui.dashboard.view;
...
import org.jkiss.sqbase.model.connection.DBPDataSourceProviderDescriptor;
import org.jkiss.sqbase.model.connection.DBPDriver;
import org.jkiss.sqbase.model.dashboard.registry.DashboardItemConfiguration;
import org.jkiss.sqbase.model.dashboard.registry.DashboardProviderDescriptor;
import org.jkiss.sqbase.model.dashboard.registry.DashboardRegistry;
...
import org.jkiss.sqbase.ui.dashboard.internal.UIDashboardActivator;
import org.jkiss.sqbase.ui.dashboard.internal.UIDashboardMessages;
import org.jkiss.sqbase.ui.dashboard.registry.DashboardRendererDescriptor;
import org.jkiss.sqbase.ui.dashboard.registry.DashboardUIRegistry;
...
public class DashboardManagerDialog extends BaseDialog {
    ...
    private static final String DIALOG_ID = "SQBase.DashboardManagerDialog";//$NON-NLS-1$
                ...
                public void update(ViewerCell cell) {
                    ...
                    if (cell.getColumnIndex() == 0) {
                        ...
                        if (element instanceof DBPDriver driver) {
                            cell.setImage(SQBaseIcons.getImage(driver.getIcon()));
                        } else if (element instanceof DashboardProviderDescriptor dpd) {
                            cell.setImage(SQBaseIcons.getImage(dpd.getIcon()));
                        } else if (element instanceof DBPDataSourceProviderDescriptor dspd) {
                            cell.setImage(SQBaseIcons.getImage(dspd.getIcon()));
                            ...
                            if (icon != null) {
                                cell.setImage(SQBaseIcons.getImage(icon));
                            }
                        }
                    } else {
                        if (element instanceof DBPDriver driver) {
