...
import org.jkiss.sqbase.model.auth.*;
import org.jkiss.sqbase.model.auth.impl.AbstractSessionPersistent;
...
public class LocalWorkspaceSession extends AbstractSessionPersistent implements SMSession, SMSessionPrincipal, SMSessionSecretKeeper {
    ...
    public static final SMSessionType DB_SESSION_TYPE = new SMSessionType("SQBase");
