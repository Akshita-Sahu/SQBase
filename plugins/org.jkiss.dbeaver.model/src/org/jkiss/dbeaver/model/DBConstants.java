...
import org.jkiss.sqbase.model.data.DBDBinaryFormatter;
import org.jkiss.sqbase.model.impl.data.formatters.BinaryFormatterBase64;
import org.jkiss.sqbase.model.impl.data.formatters.BinaryFormatterHex;
import org.jkiss.sqbase.model.impl.data.formatters.BinaryFormatterString;
...
public class DBConstants {
    ...
    public static final String CONTEXT_PARAMETER_PROJECT = "sqbase.project";
    public static final String CONTEXT_PARAMETER_DATA_SOURCE = "sqbase.datasource";

    /////////////////////////////////
    // Misc
    public static final String IS_WINDOWS_STORE_APP = "sqbase.windows.store.app";
    ...
    @Deprecated
    public static final String INTERNAL_PROP_PREFIX = "@sqbase-"; //NON-NLS-1
    ...
    public static final String LEGACY_DRIVERS_FOLDER = ".sqbase-drivers";
    public static final String DEFAULT_DRIVERS_FOLDER = "drivers";

    public static final String MODEL_BUNDLE_ID = "org.jkiss.sqbase.model";

    public static final String WORKSPACE_PROPS_FILE = "sqbase-workspace.properties"; //$NON-NLS-1$

    public static final String LABEL_NA = "N/A";

    public static final String DEBUG_LOG_FILE_NAME = "sqbase-debug.log";
