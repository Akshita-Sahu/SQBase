...
import org.jkiss.sqbase.bundle.ModelActivator;
...
public class Log {
    ...
    private static boolean TRACE_LOG_ENABLED = CommonUtils.getBoolean(System.getProperty("sqbase.trace.enabled"));
    public static final boolean DEV_DEBUG_ENABLED = CommonUtils.getBoolean(System.getProperty("sqbase.debug.enabled"));
