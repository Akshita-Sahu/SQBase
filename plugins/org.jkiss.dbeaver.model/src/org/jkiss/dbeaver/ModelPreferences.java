...
public final class ModelPreferences
{
    ...
    public static final String PLUGIN_ID = "org.jkiss.sqbase.model";
    ...
    private static void initializeDefaultPreferences(DBPPreferenceStore store) {
        ...
        PrefUtils.setDefaultPreferenceValue(store, UI_DRIVERS_SOURCES, "https://sqbase.io/files/jdbc/");
