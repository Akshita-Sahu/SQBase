 ...
 */
package org.jkiss.sqbase.ui.statistics;
...
import org.jkiss.sqbase.ui.internal.statistics.StatisticCollectionMessages;
...
public class PrefPageUsageStatistics extends AbstractPrefPage implements IWorkbenchPreferencePage, IWorkbenchPropertyPage {
    public static final String PAGE_ID = "org.jkiss.sqbase.preferences.main.usageStatistics"; //$NON-NLS-1$
    public static final String LINK_PRIVACY_INFO = "https://sqbase.com/privacy/";
    public static final String LINK_STATISTIC_DETAILS = "https://sqbase.com/privacy/";
    public static final String LINK_GIHUB_REPO = "https://github.com/sqbase/sqbase";
    ...
    protected Control createPreferenceContent(@NotNull Composite parent) {
        ...
        if (DBWorkbench.getPlatform().getApplication().isStatisticsCollectionRequired()) {
            ...
            UIUtils.createInfoLabel(composite, "You cannot opt-out from data sharing in this version of SQBase.");
        }
