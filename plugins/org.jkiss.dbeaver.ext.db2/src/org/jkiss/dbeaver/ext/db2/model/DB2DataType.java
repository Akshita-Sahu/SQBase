...
import org.jkiss.sqbase.ext.db2.model.dict.DB2DataTypeMetaType;
...
import org.jkiss.sqbase.model.DBPQualifiedObject;
...
public class DB2DataType extends DB2Object<DBSObject> implements DBSDataType, DBPQualifiedObject {
    ...
    public DB2DataType(DBSObject owner, ResultSet dbResult) throws DBException
    {
        ...
        // !MESSAGE Can't find tree node for object <database name> (org.jkiss.sqbase.ext.db2.model.DB2DataSource)
