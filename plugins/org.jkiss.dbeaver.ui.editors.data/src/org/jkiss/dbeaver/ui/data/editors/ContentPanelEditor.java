...
import org.jkiss.sqbase.model.impl.data.StringContent;
...
import org.jkiss.sqbase.ui.controls.resultset.handler.ResultSetHandlerSwitchContentViewer;
...
public class ContentPanelEditor extends BaseValueEditor<Control> implements IAdaptable {
    ...
    private class ContentTypeSwitchAction extends Action implements SelectionListener {
        ...
        ContentTypeSwitchAction() {
            ...
            setImageDescriptor(SQBaseIcons.getImageDescriptor(UIIcon.PAGES));
