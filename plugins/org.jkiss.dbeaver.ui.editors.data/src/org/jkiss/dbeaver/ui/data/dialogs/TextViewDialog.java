...
import org.jkiss.sqbase.ui.data.IHexEditorService;
    ...
    protected Composite createDialogArea(Composite parent)
    {
        ...
        }
        {
            ...
            if (hexEditorService != null) {
                ...
                item.setText("Text");
                item.setImage(SQBaseIcons.getImage(DBIcon.TYPE_TEXT));
        ...
        if (hexEditorService != null) {
            ...
            CTabItem item = new CTabItem(editorContainer, SWT.NO_FOCUS);
            item.setText("Hex");
            item.setImage(SQBaseIcons.getImage(DBIcon.TYPE_BINARY));
