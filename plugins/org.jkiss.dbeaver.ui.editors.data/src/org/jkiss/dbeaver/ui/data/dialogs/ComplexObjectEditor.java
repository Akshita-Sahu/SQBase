 ...
 */
package org.jkiss.sqbase.ui.data.dialogs;
...
import org.jkiss.sqbase.model.impl.SimpleTypedObject;
import org.jkiss.sqbase.model.impl.data.DefaultValueHandler;
import org.jkiss.sqbase.model.runtime.DBRProgressMonitor;
import org.jkiss.sqbase.model.runtime.DBRRunnableWithResult;
...
import org.jkiss.sqbase.ui.controls.resultset.ResultSetThemeSettings;
import org.jkiss.sqbase.ui.data.*;
import org.jkiss.sqbase.ui.data.managers.BaseValueManager;
import org.jkiss.sqbase.ui.data.managers.DefaultValueManager;
import org.jkiss.sqbase.ui.data.registry.ValueManagerRegistry;
...
public class ComplexObjectEditor extends TreeViewer {
    ...
    private Image getColumnImage(@NotNull ComplexElementItem item, int columnIndex) {
        if (columnIndex == 0) {
            return SQBaseIcons.getImage(DBValueFormatting.getTypeImage(item.getDataType()));
        } else {
            return null;
        }
    }
    ...
    private class AddElementAction extends Action {
        AddElementAction() {
            super(DataEditorsMessages.complex_object_editor_dialog_menu_add_element, SQBaseIcons.getImageDescriptor(UIIcon.ROW_ADD));
        }
    ...
    private class RemoveElementAction extends Action {
        RemoveElementAction() {
            super(DataEditorsMessages.complex_object_editor_dialog_menu_remove_element, SQBaseIcons.getImageDescriptor(UIIcon.ROW_DELETE));
        }
    ...
    private class MoveElementAction extends Action {
        ...
        MoveElementAction(int dir) {
            super(dir == SWT.UP
                ...
                SQBaseIcons.getImageDescriptor(dir == SWT.UP ? UIIcon.ARROW_UP : UIIcon.ARROW_DOWN));
            this.direction = dir;
        }
