...
import org.jkiss.sqbase.ui.editors.data.DatabaseDataEditor;
...
public class ReferenceValueEditor {
    ...
    private final Action actionGoBackward = new Action("Move Backward", SQBaseIcons.getImageDescriptor(UIIcon.ARROW_LEFT)) {
        @Override
        public void run() {
            controller.goToPrevPage();
        }
    }; 
    private final Action actionGoForward = new Action("Move Forward", SQBaseIcons.getImageDescriptor(UIIcon.ARROW_RIGHT)) {
        @Override
        public void run() {
