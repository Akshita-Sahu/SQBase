...
import org.jkiss.sqbase.ui.controls.resultset.panel.grouping.GroupingConfigDialog;
...
public class EditColumnsAction extends GroupingAction {
    ...
    public EditColumnsAction(@NotNull GroupingResultsContainer resultsContainer) {
        super(resultsContainer, ResultSetMessages.controls_resultset_grouping_edit, SQBaseIcons.getImageDescriptor(UIIcon.EDIT_COLUMN));
    }
