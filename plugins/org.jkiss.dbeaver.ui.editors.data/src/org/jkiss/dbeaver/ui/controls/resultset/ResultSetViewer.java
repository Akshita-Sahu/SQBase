...
import org.jkiss.sqbase.model.data.*;
...
import org.jkiss.sqbase.model.data.order.OrderingPolicy;
import org.jkiss.sqbase.model.data.order.OrderingStrategy;
import org.jkiss.sqbase.model.data.order.OrderingUtils;
import org.jkiss.sqbase.model.edit.DBEPersistAction;
import org.jkiss.sqbase.model.exec.*;
import org.jkiss.sqbase.model.impl.local.StatResultSet;
import org.jkiss.sqbase.model.messages.ModelMessages;
import org.jkiss.sqbase.model.preferences.DBPPreferenceListener;
...
import org.jkiss.sqbase.model.runtime.load.DatabaseLoadService;
...
import org.jkiss.sqbase.model.virtual.*;
import org.jkiss.sqbase.registry.ApplicationPolicyProvider;
import org.jkiss.sqbase.registry.configurator.UIPropertyConfiguratorDescriptor;
import org.jkiss.sqbase.registry.configurator.UIPropertyConfiguratorRegistry;
import org.jkiss.sqbase.registry.data.hints.ValueHintProviderDescriptor;
import org.jkiss.sqbase.registry.data.hints.ValueHintRegistry;
import org.jkiss.sqbase.runtime.DBWorkbench;
import org.jkiss.sqbase.runtime.SQBaseNotifications;
import org.jkiss.sqbase.runtime.jobs.DataSourceJob;
...
import org.jkiss.sqbase.ui.controls.autorefresh.AutoRefreshControl;
import org.jkiss.sqbase.ui.controls.resultset.actions.*;
import org.jkiss.sqbase.ui.controls.resultset.colors.CustomizeColorsAction;
import org.jkiss.sqbase.ui.controls.resultset.colors.ResetAllColorAction;
import org.jkiss.sqbase.ui.controls.resultset.colors.ResetRowColorAction;
import org.jkiss.sqbase.ui.controls.resultset.handler.*;
import org.jkiss.sqbase.ui.controls.resultset.internal.ResultSetMessages;
import org.jkiss.sqbase.ui.controls.resultset.panel.ResultSetPanelDescriptor;
import org.jkiss.sqbase.ui.controls.resultset.valuefilter.FilterValueEditPopup;
import org.jkiss.sqbase.ui.controls.resultset.view.EmptyPresentation;
import org.jkiss.sqbase.ui.controls.resultset.view.ErrorPresentation;
import org.jkiss.sqbase.ui.controls.resultset.view.StatisticsPresentation;
import org.jkiss.sqbase.ui.controls.resultset.virtual.*;
...
import org.jkiss.sqbase.ui.editors.data.preferences.PrefPageResultSetMain;
import org.jkiss.sqbase.ui.editors.text.DynamicFindReplaceTarget;
import org.jkiss.sqbase.ui.internal.UIMessages;
import org.jkiss.sqbase.ui.navigator.NavigatorCommands;
    ...
    implements DBPContextProvider, IResultSetController, ISaveablePart2, DBPAdaptable, DBPEventListener
{
    ...
    private static final String TOOLBAR_EDIT_CONTRIBUTION_ID = "toolbar:org.jkiss.sqbase.ui.controls.resultset.status.editCmds";
    private static final String TOOLBAR_NAVIGATION_CONTRIBUTION_ID = "toolbar:org.jkiss.sqbase.ui.controls.resultset.status.navCmds";
    private static final String TOOLBAR_EXPORT_CONTRIBUTION_ID = "toolbar:org.jkiss.sqbase.ui.controls.resultset.status.exportCmd";
    private static final String TOOLBAR_CONTRIBUTION_ID = "toolbar:org.jkiss.sqbase.ui.controls.resultset.status";
    private static final String TOOLBAR_CONFIGURATION_VISIBLE_PROPERTY = "org.jkiss.sqbase.ui.toolbar.configuration.visible";

    private static final String CONFIRM_SERVER_SIDE_ORDERING_UNAVAILABLE = "org.jkiss.sqbase.sql.resultset.serverSideOrderingUnavailable";
    ...
    public void saveDataFilter() {
        ...
        if (filtersPanel != null) {
            SQBaseNotifications.showNotification(
                SQBaseNotifications.NT_GENERIC,
        ...
        try {
            ...
            if (!pVisible) {
                ...
                for (ResultSetPresentationDescriptor pd : availablePresentations) {
                    ...
                    item.setImage(SQBaseIcons.getImage(pd.getIcon()));
        ...
        if (supportsPanels()) {
            ...
            if (!availablePanels.isEmpty()) {
                VerticalButton panelsButton = new VerticalButton(panelSwitchFolder, SWT.RIGHT | SWT.CHECK);
                {
                    ...
                    panelsButton.setImage(SQBaseIcons.getImage(UIIcon.PANEL_CUSTOMIZE));
                ...
                for (final ResultSetPanelDescriptor panel : availablePanels) {
                    ...
                    panelButton.setImage(SQBaseIcons.getImage(panel.getIcon()));
    ...
    public boolean activatePanel(String id, boolean setActive, boolean showPanels) {
        ...
        try {
            ...
            panelTab.setImage(SQBaseIcons.getImage(panelDescriptor.getIcon()));
    ...
    private void createStatusBar0(@NotNull Composite parent) {
        ...
        }
        {
            ...
            rowCountLabel = new ActiveStatusMessage(
                statusBar,
                SQBaseIcons.getImage(UIIcon.COMPILE),
    ...
    public void fillContextMenu(
        ...
        {
            {
                ...
                if ((decoratorFeatures & IResultSetDecorator.FEATURE_FILTERS) != 0) {
                    MenuManager filtersMenu = new MenuManager(
                        ...
                        SQBaseIcons.getImageDescriptor(UIIcon.FILTER),
                ...
                }
                {
                    MenuManager orderMenu = new MenuManager(
                        ...
                        SQBaseIcons.getImageDescriptor(UIIcon.SORT),
                ...
                final MenuManager editMenu = new MenuManager(
                    ...
                    SQBaseIcons.getImageDescriptor(UIIcon.ROW_EDIT),
                    MENU_ID_EDIT
                );
        ...
        if ((getDecorator().getDecoratorFeatures() & IResultSetDecorator.FEATURE_PANELS) != 0) {
            MenuManager panelsMenu = new MenuManager(
                ...
                SQBaseIcons.getImageDescriptor(UIIcon.PANEL_CUSTOMIZE),
        ...
        if ((getDecorator().getDecoratorFeatures() & IResultSetDecorator.FEATURE_PRESENTATIONS) != 0) {
            ...
            for (ResultSetPresentationDescriptor pd : getAvailablePresentations()) {
                Action psAction = new Action(pd.getLabel(), Action.AS_CHECK_BOX) {
                    ...
                    {
                        presentation = pd;
                        setImageDescriptor(SQBaseIcons.getImageDescriptor(presentation.getIcon()));
                    }
