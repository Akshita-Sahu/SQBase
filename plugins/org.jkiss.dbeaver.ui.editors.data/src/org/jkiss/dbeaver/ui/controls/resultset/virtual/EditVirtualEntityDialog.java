...
import org.jkiss.sqbase.model.data.DBDAttributeTransformerDescriptor;
...
import org.jkiss.sqbase.ui.dialogs.BaseTitleDialog;
import org.jkiss.sqbase.ui.dialogs.IDialogPageContainer;
import org.jkiss.sqbase.ui.editors.object.struct.EditConstraintPage;
import org.jkiss.sqbase.ui.editors.object.struct.EditDictionaryPage;
import org.jkiss.sqbase.ui.editors.object.struct.EditForeignKeyPage;
...
public class EditVirtualEntityDialog extends BaseTitleDialog implements IDialogPageContainer {
    ...
    //private static final String DIALOG_ID = "SQBase.EditVirtualEntityDialog";//$NON-NLS-1$
...
*/
    ...
    private void createDictionaryPage(CTabFolder tabFolder) {
        if (entity != null) {
            ...
            dictItem.setImage(SQBaseIcons.getImage(DBIcon.TREE_PACKAGE));
    ...
    private void createColumnsPage(CTabFolder tabFolder) {
        ...
        attrsItem.setImage(SQBaseIcons.getImage(DBIcon.TREE_COLUMN));
    ...
    private void createUniqueKeysPage(CTabFolder tabFolder) {
        ...
        ukItem.setImage(SQBaseIcons.getImage(DBIcon.TREE_UNIQUE_KEY));
    ...
    private void createForeignKeysPage(CTabFolder tabFolder) {
        ...
        fkItem.setImage(SQBaseIcons.getImage(DBIcon.TREE_FOREIGN_KEY));
    ...
    private void createForeignKeyItem(Table fkTable, DBVEntityForeignKey fk) {
        ...
        //item.setImage(0, SQBaseIcons.getImage(DBIcon.TREE_FOREIGN_KEY));
        ...
        item.setImage(2, SQBaseIcons.getImage(refEntity.getDataSource().getContainer().getDriver().getIcon()));
