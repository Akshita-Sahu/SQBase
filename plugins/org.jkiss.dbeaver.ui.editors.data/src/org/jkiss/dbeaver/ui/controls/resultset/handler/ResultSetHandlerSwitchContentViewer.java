...
public class ResultSetHandlerSwitchContentViewer extends AbstractHandler implements IElementUpdater {
    public static final String COMMAND_ID = "org.jkiss.sqbase.core.resultset.grid.switchContentViewer";
    ...
    public void updateElement(UIElement element, Map parameters) {
        ...
        if (manager != null) {
            ...
            element.setIcon(SQBaseIcons.getImageDescriptor(manager.getIcon()));
