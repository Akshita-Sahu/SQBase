...
package org.jkiss.sqbase.ui.controls.lightgrid;
...
import org.jkiss.sqbase.ui.UITextUtils;
...
class GridColumnRenderer extends AbstractRenderer {
    ...
    public static final Image IMAGE_ASTERISK = SQBaseIcons.getImage(UIIcon.SORT_UNKNOWN);
    public static final Image IMAGE_DESC = SQBaseIcons.getImage(UIIcon.SORT_INCREASE);
    public static final Image IMAGE_ASC = SQBaseIcons.getImage(UIIcon.SORT_DECREASE);
    public static final Image IMAGE_FILTER = SQBaseIcons.getImage(UIIcon.DROP_DOWN);
    ...
    public void paint(GC gc, Rectangle bounds, boolean selected, boolean hovering, GridColumn element) {
        ...
        if (!CommonUtils.isEmpty(hintInfo.icons)) {
            ...
            for (DBPImage hi : hintInfo.icons) {
                Image hintImage = SQBaseIcons.getImage(hi);
