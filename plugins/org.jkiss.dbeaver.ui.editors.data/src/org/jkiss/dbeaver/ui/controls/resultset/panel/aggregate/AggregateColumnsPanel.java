 ...
 */
package org.jkiss.sqbase.ui.controls.resultset.panel.aggregate;
...
import org.jkiss.sqbase.model.data.aggregate.IAggregateFunction;
import org.jkiss.sqbase.registry.functions.AggregateFunctionDescriptor;
import org.jkiss.sqbase.registry.functions.FunctionsRegistry;
import org.jkiss.sqbase.ui.*;
import org.jkiss.sqbase.ui.controls.ToolbarSeparatorContribution;
import org.jkiss.sqbase.ui.controls.resultset.*;
import org.jkiss.sqbase.ui.controls.resultset.internal.ResultSetMessages;
import org.jkiss.sqbase.ui.controls.resultset.panel.ResultSetPanelBase;
...
public class AggregateColumnsPanel extends ResultSetPanelBase {
    ...
    private void aggregateSelection(@NotNull IResultSetSelection selection) {
        ...
        if (groupByColumns) {
            ...
            for (Map.Entry<DBDAttributeBinding, List<Object>> entry : attrValues.entrySet()) {
                ...
                attrItem.setImage(SQBaseIcons.getImage(DBValueFormatting.getObjectImage(entry.getKey())));
    ...
    private void aggregateValues(TreeItem parentItem, Collection<Object> values) {
        ...
        for (AggregateFunctionDescriptor funcDesc : functions) {
            ...
            if (icon != null) {
                funcItem.setImage(0, SQBaseIcons.getImage(icon));
            }
            try {
    ...
    private class GroupByColumnsAction extends Action {
        public GroupByColumnsAction() {
            ...
            setImageDescriptor(SQBaseIcons.getImageDescriptor(UIIcon.GROUP_BY_ATTR));
    ...
    private class ValueTypeToggleAction extends Action {
        public ValueTypeToggleAction() {
            ...
            setImageDescriptor(SQBaseIcons.getImageDescriptor(
    ...
    private class AddFunctionAction extends Action {
        public AddFunctionAction() {
            super(UIMessages.button_add, SQBaseIcons.getImageDescriptor(UIIcon.ADD));
    ...
    private class AddFunctionItemAction extends Action {
        ...
        public AddFunctionItemAction(AggregateFunctionDescriptor func) {
            super(func.getLabel(), func.getIcon() == null ? null : SQBaseIcons.getImageDescriptor(func.getIcon()));
            this.func = func;
        }
    ...
    private class RemoveFunctionAction extends Action {
        public RemoveFunctionAction() {
            super(ResultSetMessages.aggregate_columns_remove_function_text, SQBaseIcons.getImageDescriptor(UIIcon.DELETE));
        }
    ...
    private class ResetFunctionsAction extends Action {
        public ResetFunctionsAction() {
            super(ResultSetMessages.aggregate_columns_reset_text, SQBaseIcons.getImageDescriptor(UIIcon.CANCEL));
        }
