...
import org.jkiss.sqbase.ui.controls.resultset.ResultSetSaveReport;
import org.jkiss.sqbase.ui.controls.resultset.ResultSetSaveSettings;
import org.jkiss.sqbase.ui.controls.resultset.ResultSetViewer;
import org.jkiss.sqbase.ui.dialogs.DetailsViewDialog;
...
public class SavePreviewDialog extends DetailsViewDialog {
    ...
    private static final String DIALOG_ID = "SQBase.RSV.SavePreviewDialog";//$NON-NLS-1$
    ...
    protected void createMessageArea(Composite composite) {
...

        {
            ...
            imgLabel.setImage(SQBaseIcons.getImage(DBIcon.STATUS_WARNING));
