 ...
 */
package org.jkiss.sqbase.ui.controls.resultset.panel.references;
...
class ReferencesResultsContainer implements IResultSetContainer {
     ...
     * See <a href="https://github.com/sqbase/sqbase/issues/11201">this ticket.</a>
     *
     */
    @Nullable
    ...
    private class RefKeyLabelProvider extends LabelProvider {
        ...
        public Image getImage(Object element) {
            if (element == null) {
                return SQBaseIcons.getImage(DBIcon.TREE_ASSOCIATION);
            }
