 ...
 */
package org.jkiss.sqbase.ui.controls.resultset.view;
...
import org.jkiss.sqbase.ui.controls.resultset.IResultSetContainer;
import org.jkiss.sqbase.ui.controls.resultset.IResultSetErrorAction;
import org.jkiss.sqbase.ui.controls.resultset.ResultSetErrorActionDescriptor;
import org.jkiss.sqbase.ui.controls.resultset.ResultSetErrorActionRegistry;
...
class ErrorDetailsPart {
    ...
    private Image getImage() {
        return switch (reason.getSeverity()) {
            case IStatus.ERROR -> SQBaseIcons.getImage(DBIcon.STATUS_ERROR);
            case IStatus.WARNING -> SQBaseIcons.getImage(DBIcon.STATUS_WARNING);
            default -> SQBaseIcons.getImage(DBIcon.STATUS_INFO);
        };
    }
