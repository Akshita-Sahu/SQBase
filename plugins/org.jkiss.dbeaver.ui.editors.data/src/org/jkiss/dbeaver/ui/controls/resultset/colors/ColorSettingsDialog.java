 ...
 */
package org.jkiss.sqbase.ui.controls.resultset.colors;
...
import org.jkiss.sqbase.model.virtual.DBVColorOverride;
...
import org.jkiss.sqbase.ui.data.managers.StringValueManager;
...
public class ColorSettingsDialog extends BaseDialog {
    ...
    private static final String DIALOG_ID = "SQBase.ColorSettingsDialog2";//$NON-NLS-1$
...
*/
    ...
    private void createAttributeSelectorArea(Composite composite) {
        ...
        for (DBDAttributeBinding attr : resultSetViewer.getModel().getVisibleAttributes()) {
            ...
            attrItem.setImage(0, SQBaseIcons.getImage(DBValueFormatting.getObjectImage(attr, true)));
