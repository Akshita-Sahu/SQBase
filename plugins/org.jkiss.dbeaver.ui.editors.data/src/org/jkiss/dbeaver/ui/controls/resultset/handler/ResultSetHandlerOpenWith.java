 ...
 */
package org.jkiss.sqbase.ui.controls.resultset.handler;
...
import org.jkiss.sqbase.tools.transfer.DTConstants;
import org.jkiss.sqbase.tools.transfer.IDataTransferConsumer;
import org.jkiss.sqbase.tools.transfer.IDataTransferProcessor;
import org.jkiss.sqbase.tools.transfer.database.DatabaseProducerSettings;
import org.jkiss.sqbase.tools.transfer.database.DatabaseProducerSettings.FetchedRowsPolicy;
...
import org.jkiss.sqbase.tools.transfer.stream.IStreamDataExporter;
...
public class ResultSetHandlerOpenWith extends AbstractHandler implements IElementUpdater {
    ...
    public static final String CMD_OPEN_WITH = "org.jkiss.sqbase.core.resultset.openWith";
    public static final String PARAM_PROCESSOR_ID = "processorId";

    public static final String PARAM_ACTIVE_APP = "org.jkiss.sqbase.core.resultset.openWith.currentApp";
    public static final String PREF_OPEN_WITH_DEFAULT_PROCESSOR = "org.jkiss.sqbase.core.resultset.openWith.defaultprocessor";
    ...
    public void updateElement(UIElement element, Map parameters) {
        ...
        if (processor != null) {
            ...
            if (processor.getIcon() != null) {
                element.setIcon(SQBaseIcons.getImageDescriptor(processor.getIcon()));
            }
        }
    }
        ...
        protected IContributionItem[] getContributionItems() {
            ...
            for (DataTransferProcessorDescriptor processor : getDataFileTransferProcessors(rsv)) {
                Action setDefaultAction = new Action(processor.getAppName(), Action.AS_RADIO_BUTTON) {
                    {
                        //setImageDescriptor(SQBaseIcons.getImageDescriptor(processor.getIcon()));
                        if (!CommonUtils.isEmpty(processor.getDescription())) {
    ...
    public static void fillOpenWithMenu(ResultSetViewer viewer, IContributionManager openWithMenu) {
        for (DataTransferProcessorDescriptor processor : getDataFileTransferProcessors(viewer)) {
            ...
            if (processor.getIcon() != null) {
                params.icon = SQBaseIcons.getImageDescriptor(processor.getIcon());
            }
