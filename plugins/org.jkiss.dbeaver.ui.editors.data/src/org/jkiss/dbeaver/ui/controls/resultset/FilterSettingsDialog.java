...
import org.jkiss.sqbase.model.data.DBDAttributeConstraintBase;
...
class FilterSettingsDialog extends HelpEnabledDialog {
    private static final String DIALOG_ID = "SQBase.FilterSettingsDialog";//$NON-NLS-1$
    ...
    protected Composite createDialogArea(Composite parent)
    {
        ...
        getShell().setImage(SQBaseIcons.getImage(UIIcon.FILTER));
...

        {
            ...
            columnsController.addColumn(ResultSetMessages.controls_resultset_filter_column_name, null, SWT.LEFT, true, false, new CellLabelProvider() {
                ...
                public void update(ViewerCell cell) {
                    ...
                    cell.setImage(SQBaseIcons.getImage(DBValueFormatting.getObjectImage(binding.getMetaAttribute())));
                }
            });
                ...
                columnsController.addColumn(ResultSetMessages.controls_resultset_filter_column_order, null, SWT.LEFT, true, false, new CellLabelProvider() {
                    ...
                    public void update(ViewerCell cell) {
                        ...
                        if (constraint.getOrderPosition() > 0) {
                            ...
                            cell.setImage(SQBaseIcons.getImage(constraint.isOrderDescending() ? UIIcon.SORT_INCREASE : UIIcon.SORT_DECREASE));
                        } else {
                            cell.setText(null);
                            cell.setImage(null);
                        }
...
//            constraint.setVisualPosition(this.constraints.indexOf(constraint));
    ...
    class ColumnLabelProvider extends LabelProvider implements ITableLabelProvider
    {
        ...
        public Image getColumnImage(Object element, int columnIndex)
        {
            ...
            if (columnIndex == 2) {
                ...
                if (constraint.getOrderPosition() > 0) {
                    return SQBaseIcons.getImage(constraint.isOrderDescending() ? UIIcon.SORT_INCREASE : UIIcon.SORT_DECREASE);
                }
            }
            return null;
        }
    ...
    private static ToolItem createToolItem(ToolBar toolBar, String text, DBIcon icon, final Runnable action)
    {
        ...
        if (icon != null) {
            item.setImage(SQBaseIcons.getImage(icon));
        }
        if (text != null) {
            //item.setText(text);
     ...
     *
     * See https://github.com/sqbase/sqbase/issues/10346
     * See org.jkiss.sqbase.ui.properties.PropertyTreeViewer.saveEditorValues()
     */
