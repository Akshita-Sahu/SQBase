...
import org.jkiss.sqbase.ui.UIElementFontStyle;
import org.jkiss.sqbase.ui.UIUtils;
import org.jkiss.sqbase.ui.controls.CustomToolTipHandler;
import org.jkiss.sqbase.ui.dnd.LocalObjectTransfer;
    ...
    private void drawTopLeftCell(GC gc, int x, int y, int width, int height) {
...

        {
            ...
            for (IGridStatusColumn gsc : statusColumns) {
                ...
                if (statusIcon != null) {
                    Image statusImage = SQBaseIcons.getImage(statusIcon);
