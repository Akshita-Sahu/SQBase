...
public class GridCellRenderer extends AbstractRenderer {
    ...
    static final Image LINK_IMAGE = SQBaseIcons.getImage(UIIcon.LINK);
    static final Image LINK2_IMAGE = SQBaseIcons.getImage(UIIcon.LINK2);
    ...
    public void paint(GC gc, Rectangle bounds, boolean selected, boolean focus, boolean hover, IGridColumn col, IGridRow row) {
...

        {
            ...
            if (cellImage != null) {
                image = SQBaseIcons.getImage(cellImage);
    ...
    private void renderHints(
        ...
        if (hover || focus) {
            ...
            for (IGridHint hint : cellHints) {
                ...
                if (hintIcon != null) {
                    Image hintImage = SQBaseIcons.getImage(hintIcon);
