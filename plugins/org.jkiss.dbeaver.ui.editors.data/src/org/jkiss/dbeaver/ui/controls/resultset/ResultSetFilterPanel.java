...
import org.jkiss.sqbase.model.runtime.SystemJob;
...
import org.jkiss.sqbase.model.sql.parser.SQLWordPartDetector;
...
import org.jkiss.sqbase.runtime.ui.UIServiceSQL;
import org.jkiss.sqbase.ui.*;
import org.jkiss.sqbase.ui.contentassist.ContentAssistUtils;
import org.jkiss.sqbase.ui.contentassist.ContentProposalExt;
import org.jkiss.sqbase.ui.controls.DoubleClickMouseAdapter;
import org.jkiss.sqbase.ui.controls.StyledTextUtils;
import org.jkiss.sqbase.ui.controls.resultset.actions.FilterResetAllPinsAction;
import org.jkiss.sqbase.ui.controls.resultset.actions.FilterResetAllSettingsAction;
import org.jkiss.sqbase.ui.controls.resultset.actions.FilterResetAllTransformersAction;
...
import org.jkiss.sqbase.ui.controls.resultset.spreadsheet.SpreadsheetCommandHandler;
import org.jkiss.sqbase.ui.css.CSSUtils;
import org.jkiss.sqbase.ui.css.ICSSBackgroundMimicControl;
    ...
    ResultSetFilterPanel(@NotNull ResultSetViewer rsv, @NotNull Composite parent, boolean compactMode) {
...

        {
            ...
            if (!compactMode) {
                ...
                filtersClearButton.setImage(SQBaseIcons.getImage(UIIcon.ERASE));
            ...
            filtersCustomButton.setImage(SQBaseIcons.getImage(UIIcon.FILTER));
            ...
            if (!compactMode) {
                ...
                historyBackButton.setImage(SQBaseIcons.getImage(UIIcon.RS_BACK));
                ...
                historyForwardButton.setImage(SQBaseIcons.getImage(UIIcon.RS_FORWARD));
...
//        gl.horizontalSpacing = 0;
        ...
        if (activeObjectImage != null) {
            iconLabel.setImage(SQBaseIcons.getImage(activeObjectImage));
        }
    ...
    private class ActiveObjectPanel extends FilterPanel {
        ...
        public Point computeSize(int wHint, int hHint, boolean changed) {
            ...
            DBPImage activeObjectImage = getActiveObjectImage();
            if (activeObjectImage != null) {
                Image image = SQBaseIcons.getImage(activeObjectImage);
        ...
        protected void paintPanel(PaintEvent e) {
            ...
            DBPImage activeObjectImage = getActiveObjectImage();
            if (activeObjectImage != null) {
                Image icon = SQBaseIcons.getImage(activeObjectImage);
    ...
    private class HistoryPanel extends FilterPanel {
        ...
        HistoryPanel(Composite addressBar) {
            ...
            dropImageE = SQBaseIcons.getImage(UIIcon.DROP_DOWN);
    ...
    private class FilterExpandPanel extends FilterPanel {
        ...
        FilterExpandPanel(Composite addressBar) {
            ...
            enabledImageExpand = SQBaseIcons.getImage(UIIcon.FIT_WINDOW);
            disabledImageExpand = new Image(enabledImageExpand.getDevice(), enabledImageExpand, SWT.IMAGE_GRAY);
            enabledImageCollapse = SQBaseIcons.getImage(UIIcon.ORIGINAL_SIZE);
    ...
    private abstract class ToolItemPanel extends FilterPanel {
        ...
        protected ToolItemPanel(Composite addressBar, DBPImage image, String toolTip, int style) {
            ...
            enabledImage = SQBaseIcons.getImage(image);
        ...
        protected void paintPanel(PaintEvent e) {
            ...
            if (viewer.isRefreshInProgress()) {
                e.gc.drawImage(SQBaseIcons.getImage(UIIcon.CLOSE), x, e.y + 2);
