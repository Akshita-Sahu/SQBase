...
import org.jkiss.sqbase.model.data.DBDValueDefaultGenerator;
...
import org.jkiss.sqbase.ui.actions.ConnectionCommands;
...
import org.jkiss.sqbase.ui.editors.MultiPageAbstractEditor;
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        switch (actionId) {
            ...
            case IResultSetCommands.CMD_NAVIGATE_LINK: {
                // FIXME: Should probably rely on hints; see org.jkiss.sqbase.ui.data.DBDValueHintActionHandler
    ...
    public void updateElement(UIElement element, Map parameters) {
        if (parameters.get(IResultSetCommands.PARAM_EXPORT_WITH_PARAM) != null) {
            ...
            if (descriptor == null) {
                ...
                element.setIcon(SQBaseIcons.getImageDescriptor(descriptor.getIcon()));
