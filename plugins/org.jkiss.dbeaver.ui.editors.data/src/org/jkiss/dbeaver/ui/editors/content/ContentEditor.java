 ...
 */
package org.jkiss.sqbase.ui.editors.content;
...
import org.jkiss.sqbase.ui.controls.ColumnInfoPanel;
...
import org.jkiss.sqbase.ui.data.managers.stream.TextStreamValueManager;
import org.jkiss.sqbase.ui.data.registry.StreamValueManagerDescriptor;
...
/*
    ...
    public void resourceChanged(IResourceChangeEvent event)
    {
            ...
            (delta.getFlags() & IResourceDelta.CONTENT) != 0)
        {
            ...
            dirty = true;
            SQBaseUI.asyncExec(new Runnable() {
                @Override
                public void run() {
