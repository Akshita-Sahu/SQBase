 ...
 */
package org.jkiss.sqbase.ui.editors.data;
...
import org.jkiss.sqbase.ui.ConComposite;
import org.jkiss.sqbase.ui.SQBaseIcons;
import org.jkiss.sqbase.ui.UIUtils;
import org.jkiss.sqbase.ui.controls.resultset.virtual.EditVirtualColumnsPage;
import org.jkiss.sqbase.ui.controls.resultset.virtual.EditVirtualEntityDialog;
...
//        attrsComposite.setLayoutData(new GridData(GridData.FILL_BOTH));
    ...
    private void createUniqueKeyItem(Table ukTable, DBVEntityConstraint uk) {
        ...
        item.setImage(0, SQBaseIcons.getImage(DBIcon.TREE_UNIQUE_KEY));
