...
import org.jkiss.sqbase.model.data.DBDContentStorageLocal;
...
import org.jkiss.sqbase.ui.editors.IStatefulEditorInput;
...
public class ContentEditorInput implements IPathEditorInput, IStatefulEditorInput, DBPContextProvider, IEncodingSupport
{
    ...
    {
        return SQBaseIcons.getImageDescriptor(DBIcon.TYPE_LOB);
    }
