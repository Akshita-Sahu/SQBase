...
public class Constants {
    ...
    public static final String DBEAVER_INSTANCE_PROPS = "sqbase-instance.properties";

    public static final String ARG_FORCE_CLI_MODE = "-cli-mode";

    public static final String PRODUCT_TEAM = "com.sqbase.app.team";
    public static final String PRODUCT_CLOUDBEAVER   = "io.clousqbase";

    public static final String DISABLE_REMOTE_CLI = "sqbase.disable.remote.cli.execution";
