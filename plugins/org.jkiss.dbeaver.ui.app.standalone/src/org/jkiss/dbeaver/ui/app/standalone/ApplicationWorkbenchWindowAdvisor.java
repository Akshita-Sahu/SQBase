...
import org.jkiss.sqbase.registry.WorkbenchHandlerRegistry;
...
public class ApplicationWorkbenchWindowAdvisor extends IDEWorkbenchWindowAdvisor implements DBPProjectListener, IResourceChangeListener {
    ...
    public ApplicationWorkbenchWindowAdvisor(
        ...
        if (SQBaseApplication.WORKSPACE_MIGRATED) {
            refreshProjects();
        }
    ...
    public void postWindowCreate() {
        ...
        try {
            SQBaseCommandLine.getInstance().executeCommandLineCommands(
                SQBaseApplication.getInstance().getInstanceServer(),
                true,
                false,
