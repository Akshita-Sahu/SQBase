...
import org.jkiss.sqbase.ui.app.standalone.about.AboutBoxAction;
import org.jkiss.sqbase.ui.app.standalone.internal.CoreApplicationMessages;
import org.jkiss.sqbase.ui.app.standalone.update.CheckForUpdateAction;
import org.jkiss.sqbase.ui.controls.StatusLineContributionItemEx;
    ...
    private void patchSearchIcons(IActionSetDescriptor actionSet) {
        ...
        for (IConfigurationElement searchActionItem : actionSet.getConfigurationElement().getChildren()) {
            ...
            if ("org.eclipse.search.OpenSearchDialog".equals(saId) || "org.eclipse.search.OpenSearchDialogPage".equals(saId)) {
                patchActionSetIcon(searchActionItem, "platform:/plugin/org.jkiss.sqbase.ui/icons/misc/search.svg");
...
//        register(historyForwardAction);
    ...
    private void patchImages() {
        ...
        //WorkbenchImages.declareImage(IWorkbenchGraphicConstants.IMG_WIZBAN_IMPORT_WIZ, SQBaseIcons.getImageDescriptor(UIIcon.IMPORT), true);
        //WorkbenchImages.declareImage(IWorkbenchGraphicConstants.IMG_WIZBAN_EXPORT_WIZ, SQBaseIcons.getImageDescriptor(UIIcon.EXPORT), true);
    ...
    private void bindImage(CommandImageService cis, String commandId, DBIcon icon) {
        ImageDescriptor id = SQBaseIcons.getImageDescriptor(icon);
