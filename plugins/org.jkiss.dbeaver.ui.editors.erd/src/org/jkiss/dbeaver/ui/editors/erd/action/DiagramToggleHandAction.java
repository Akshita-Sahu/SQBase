 ...
 *
 * @see org.jkiss.sqbase.ui.editors.erd.editor.tools.HandToolEntry
 */
public class DiagramToggleHandAction extends Action implements PaletteListener, Disposable {
    public static final String CMD_TOGGLE_HAND = "org.jkiss.sqbase.erd.toggleHand";
    ...
    public DiagramToggleHandAction(@NotNull PaletteViewer viewer) {
        ...
        setImageDescriptor(SQBaseIcons.getImageDescriptor(ERDIcon.MOVE));
    }
