...
import org.jkiss.sqbase.ui.editors.erd.model.ERDDatabaseObjectModifyCommand;
import org.jkiss.sqbase.ui.navigator.dialogs.NavigatorNodesDeletionConfirmations;
    ...
    public void updateElement(UIElement element, Map parameters) {
        ...
        if (editor != null) {
            if (editor.getDiagram().isEditEnabled()) {
                ...
                element.setIcon(SQBaseIcons.getImageDescriptor(UIIcon.DELETE));
            } else {
                element.setText(ERDUIMessages.erd_action_remove_text);
                element.setIcon(SQBaseIcons.getImageDescriptor(UIIcon.OBJ_REMOVE));
            }
        }*/
