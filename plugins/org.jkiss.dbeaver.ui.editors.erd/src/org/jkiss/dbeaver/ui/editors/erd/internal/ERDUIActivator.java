 ...
 */
package org.jkiss.sqbase.ui.editors.erd.internal;
...
public class ERDUIActivator extends AbstractUIPlugin {
    ...
    public static final String PLUGIN_ID = "org.jkiss.sqbase.ui.editors.erd"; // $NON-NLS-0$
    ...
    private void overloadGEFImage() {
        try {
            ...
            InternalImages.class.getMethod(
                ...
                .invoke(null, InternalImages.IMG_PALETTE, SQBaseIcons.getImage(UIIcon.PALETTE));
        } catch (Throwable e) {
            log.debug(e);
        }
    }
