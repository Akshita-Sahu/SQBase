...
import org.jkiss.sqbase.ui.editors.erd.editor.ERDEditorAdapter;
import org.jkiss.sqbase.ui.editors.erd.editor.ERDEditorPart;


public class ERDHandlerFocus extends AbstractHandler {
    
    private static final String DIAGRAM_FOCUS = "org.jkiss.sqbase.erd.focus.diagram";
    private static final String PALETTE_FOCUS = "org.jkiss.sqbase.erd.focus.palette";
    private static final String OUTLINE_FOCUS = "org.jkiss.sqbase.erd.focus.outline";
    private static final String PARAMETER_FOCUS= "org.jkiss.sqbase.erd.focus.parameter";
