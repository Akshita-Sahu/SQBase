 ...
 */
package org.jkiss.sqbase.ui.editors.erd.model;
...
import org.jkiss.sqbase.ui.editors.erd.editor.ERDEditPartFactory;
import org.jkiss.sqbase.ui.editors.erd.editor.ERDViewStyle;
import org.jkiss.sqbase.ui.editors.erd.editor.tools.HandToolEntry;
import org.jkiss.sqbase.ui.editors.erd.editor.tools.SelectionToolEntry;
...
public class ERDDecoratorDefault implements ERDDecorator {
    ...
    public static final ImageDescriptor CONNECT_IMAGE = SQBaseIcons.getImageDescriptor(DBIcon.TREE_ASSOCIATION);
    public static final ImageDescriptor FOREIGN_KEY_IMAGE = SQBaseIcons.getImageDescriptor(DBIcon.TREE_FOREIGN_KEY);
    public static final ImageDescriptor NOTE_IMAGE = SQBaseIcons.getImageDescriptor(ERDIcon.NOTE);
    ...
    protected PaletteDrawer createToolsDrawer(PaletteRoot paletteRoot) {
        PaletteDrawer controls = new PaletteDrawer("Tools", SQBaseIcons.getImageDescriptor(UIIcon.CONFIGURATION));
