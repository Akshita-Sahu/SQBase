 ...
 */
package org.jkiss.sqbase.ui.editors.erd.figures;
...
import org.jkiss.sqbase.ui.editors.erd.ERDColors;
...
import org.jkiss.sqbase.ui.editors.erd.part.EntityPart;
...
public class EntityFigure extends Figure {
    ...
    public EntityFigure(EntityPart part)
    {
        ...
        Image tableImage = SQBaseIcons.getImage(entity.getObject().getEntityType().getIcon());
...
*/
    ...
    private IFigure createToolTip() {
...

        {
            ...
            dsLabel.setIcon(SQBaseIcons.getImage(dataSource.getDriver().getIcon()));
        ...
        }
        {
            ...
            entityLabel.setIcon(SQBaseIcons.getImage(entity.getObject().getEntityType().getIcon()));
