...
package org.jkiss.sqbase.debug.ui;
...
import org.jkiss.sqbase.debug.ui.internal.DebugConfigurationPanelDescriptor;
import org.jkiss.sqbase.debug.ui.internal.DebugConfigurationPanelRegistry;
import org.jkiss.sqbase.debug.ui.internal.DebugUIMessages;
...
import org.jkiss.sqbase.ui.controls.SelectDataSourceCombo;
...
public class DatabaseDebugConfigurationTab extends AbstractLaunchConfigurationTab implements DBGConfigurationPanelContainer {
    ...
    public Image getImage() {
        if (connectionCombo != null) {
            DBPDataSourceContainer dataSource = connectionCombo.getSelectedItem();
            if (dataSource != null) {
                return SQBaseIcons.getImage(dataSource.getDriver().getIcon());
            }
        }
        return SQBaseIcons.getImage(DBIcon.TREE_DATABASE);
    }
