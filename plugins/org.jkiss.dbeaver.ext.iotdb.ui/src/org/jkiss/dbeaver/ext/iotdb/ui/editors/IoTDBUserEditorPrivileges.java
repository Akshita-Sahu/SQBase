...
package org.jkiss.sqbase.ext.iotdb.ui.editors;
...
import org.jkiss.sqbase.ext.iotdb.model.IoTDBGrant;
import org.jkiss.sqbase.ext.iotdb.model.IoTDBPrivilege;
import org.jkiss.sqbase.ext.iotdb.model.IoTDBRelationalUser;
import org.jkiss.sqbase.ext.iotdb.ui.config.IoTDBCommandGrantPrivilege;
import org.jkiss.sqbase.ext.iotdb.ui.controls.PrivilegeTableControl;
import org.jkiss.sqbase.ext.iotdb.ui.internal.IoTDBUiMessages;
...
public class IoTDBUserEditorPrivileges extends IoTDBUserEditorAbstract {
    ...
    public void createPartControl(Composite parent) {
        ...
        // databases
        {
            ...
            item.setText("(ALL)");
            item.setImage(SQBaseIcons.getImage(DBIcon.TREE_DATABASE));
                ...
                public void completeLoading(List<String> tables) {
                    ...
                    if (tables != null) {
                        for (String table : tables) {
                            ...
                            item.setText(table);
                            item.setImage(SQBaseIcons.getImage(DBIcon.TREE_TABLE));
                            item.setData(table);
                        }
                        highlightTables();
                    }
