 ...
 */
package org.jkiss.sqbase.ext.athena.ui.views;
...
import org.jkiss.sqbase.ext.athena.model.AWSRegion;
import org.jkiss.sqbase.ext.athena.model.AthenaConstants;
import org.jkiss.sqbase.ext.athena.ui.AthenaActivator;
import org.jkiss.sqbase.ext.athena.ui.internal.AthenaMessages;
...
import org.jkiss.sqbase.model.navigator.fs.DBNFileSystem;
import org.jkiss.sqbase.model.navigator.fs.DBNFileSystems;
...
import org.jkiss.sqbase.ui.navigator.dialogs.ObjectBrowserDialogBase;
...

        {
            ...
            if (FileSystemProviderRegistry.getInstance().getProvider("aws-s3") != null) {
                ...
                UIUtils.createPushButton(
                    ...
                    SQBaseIcons.getImage(UIIcon.OPEN),
