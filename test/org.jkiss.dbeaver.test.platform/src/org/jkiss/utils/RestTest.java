...
public class RestTest extends SQBaseUnitTest {
    @Test
    public void restClientServerTest() {
        ...
        Assert.assertEquals(Map.of("version", "1.0", "name", "sqbase"), client.getSettings());
        Assert.assertEquals("1.0", client.getSetting("version"));
        Assert.assertEquals("sqbase", client.getSetting("name"));
    ...
    private static class ControllerImpl implements Controller {
        ...
        public Map<String, Object> getSettings() {
            return Map.of("version", "1.0", "name", "sqbase");
        }
