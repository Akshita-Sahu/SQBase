...
========================
  ...
  -f <sql-file1 [sql-file2..]>
    ...
    This command can be used to associate SQL files with SQBase in shell.

  -nosplash
    Do not show splash screen

  -data <path>
    Store all projects/configuration in folder <path>. By default SQBase
	stores all its data in user's home "SQBaseData" folder.
	<path> can be an absolute or relative directory name.
	If you want to use SQBase as redistributable program start it
	with arguments like "sqbase -data workspace".
  ...
  -clean
    Clears all Eclipse caches. Use it if SQBase fails to start after version upgrade.
...
Web
==========
  Main web site: https://sqbase.io
  Source code: https://github.com/sqbase/sqbase
  Issue tracker: https://github.com/sqbase/sqbase/issues
